  ...
  $.fn.toolbar = function(options) {
    ...
    var pluginName = 'toolbar',
        defaults = {
          ...
          favorButtonset: false // If "resizeContainers" is true, setting this to true will try to display as many buttons as possible while resizing the toolbar.  Setting to false attempts to show the entire title instead.
        },
