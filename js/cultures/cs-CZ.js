(function (factory) {
  ...
  Locale.addCulture('cs-CZ', {
    ...
    messages: {
      'AboutText': {id: 'AboutText', value: 'Copyright &copy; {0} Infor. Všechna práva vyhrazena. Zde použité výrazy a designové značky jsou ochrannými známkami nebo registrovanými ochrannými známkami společnosti Infor nebo jejích partnerů a dceřiných společností. Všechna práva vyhrazena. Všechny ostatní ochranné známky zde uvedené jsou v držení svých příslušných vlastníků.'},
      ...
      'Bookmarked': {id: 'Bookmarked', value: 'Se záložkou', comment: 'Bookmark filled'},
      'BookmarkThis': {id: 'BookmarkThis', value: 'Přidat záložku', comment: 'Bookmark outlined'},
      ...
      'EitherSelectedOrNotSelected': {id: 'EitherSelectedOrNotSelected', value: 'Vybrané neb nevybrané', comment: 'Either Selected Or NotSelected in icons for filtering'},
      ...
      'GreaterOrEquals': {id: 'GreaterOrEquals', value: 'Větší než nebo rovno', comment: 'Greater Or Equals in icons for filtering'},
      ...
      'JustifyCenter': {id: 'JustifyCenter', value: 'Zarovnat na střed', comment: 'justify text to center in the editor'},
      ...
      'LeftAlign': {id: 'LeftAlign', value: 'Zarovnat doleva', comment: 'Left Align tooltip'},
      'LeftTextAlign': {id: 'LeftTextAlign', value: 'Zarovnat text doleva', comment: 'Left Text Align tooltip'},
      'LessOrEquals': {id: 'LessOrEquals', value: 'Menší než nebo rovno', comment: 'Less Or Equals in icons for filtering'},
      ...
      'MapPin': {id: 'MapPin', value: 'Špendlík na mapě', comment: 'Map Pin tooltip'},
      ...
      'MultiselectWith': {id: 'MultiselectWith', value: 'Vícenásobný výběr ', comment: 'the minutes portion of a time'},
      ...
      'OrderedList': {id: 'OrderedList', value: 'Uspořádaný seznam', comment: 'Insert an Ordered list in the editor'},
      ...
      'Right': {id: 'Right', value: 'Vpravo', comment: 'Right tooltip'},
      'RightAlign': {id: 'RightAlign', value: 'Zarovnat doprava', comment: 'Right Align tooltip'},
      'RightAlignText': {id: 'RightAlignText', value: 'Zarovnat text doprava', comment: 'Right Align Text tooltip'},
      ...
      'SortAtoZ': {id: 'SortAtoZ', value: 'Řadit A až Z', comment: 'Sort A to Z in icons for filtering'},
      'SortZtoA': {id: 'SortZtoA', value: 'Řadit Z až A', comment: 'Sort Z to A in icons for filtering'},
      ...
      'Tack': {id: 'Tack', value: 'Špendlík', comment: 'Tack tooltip'},
      ...
      'UnorderedList': {id: 'UnorderedList', value: 'Neuspořádaný seznam', comment: 'Insert an Unordered list in the editor'},
      ...
      'VerticalMiddleAlign': {id: 'VerticalMiddleAlign', value: 'Svislé zarovnání na střed', comment: 'Vertical Middle Align tooltip'},
