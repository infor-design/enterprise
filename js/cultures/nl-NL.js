(function (factory) {
  ...
  Locale.addCulture('nl-NL', {
   ...
   messages: {
      ...
      'NewItem': {id: 'NewItem', value: 'Nieuw artikel', comment: 'New item in listbuilder'},
