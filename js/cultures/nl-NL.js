(function (factory) {
  ...
  Locale.addCulture('nl-NL', {
    ...
    messages: {
      ...
      'Bookmarked': {id: 'Bookmarked', value: 'Als favoriet opgeslagen', comment: 'Bookmark filled'},
      ...
      'MultiselectWith': {id: 'MultiselectWith', value: '. Meerdere selecties met ', comment: 'the minutes portion of a time'},
      ...
      'OrderedList': {id: 'OrderedList', value: 'Gerangschikte lijst', comment: 'Insert an Ordered list in the editor'},
      ...
      'PasswordValidation': {id: 'PasswordValidation', value: '<div class="password-Tooltip"><strong>Wachtwoord:</strong><ul><li>Ten minste tien tekens</li><li>Ten minste één hoofdletter</li><li>Ten minste één kleine letter</li><li><strong>Eén speciaal teken</strong></li><li>Mag niet gelijk zijn aan uw gebruikersnaam</li><li>Mag niet gelijk zijn aan eerder gebruikt wachtwoord</li></ul></div>', comment: 'Password validation requirements'},
      ...
      'Right': {id: 'Right', value: 'Rechts', comment: 'Right tooltip'},
      ...
      'SortAtoZ': {id: 'SortAtoZ', value: 'Sorteren van A naar Z', comment: 'Sort A to Z in icons for filtering'},
      'SortZtoA': {id: 'SortZtoA', value: 'Sorteren van Z naar A', comment: 'Sort Z to A in icons for filtering'},
      ...
      'Tack': {id: 'Tack', value: 'Vastpinnen', comment: 'Tack tooltip'},
      ...
      'UnorderedList': {id: 'UnorderedList', value: 'Niet-gerangschikte lijst', comment: 'Insert an Unordered list in the editor'},
      ...
      'VerticalMiddleAlign': {id: 'VerticalMiddleAlign', value: 'Verticaal centreren', comment: 'Vertical Middle Align tooltip'},
