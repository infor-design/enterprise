(function (factory) {
  ...
  Locale.addCulture('ja-JP', {
    ...
    messages: {
      ...
      'Bookmarked': {id: 'Bookmarked', value: 'ブックマーク付', comment: 'Bookmark filled'},
      'BookmarkThis': {id: 'BookmarkThis', value: 'これをブックマーク', comment: 'Bookmark outlined'},
      ...
      'FileUpload': {id: 'FileUpload', value: 'ファイルをアップロードするには、Enter キーを押してファイルを参照します', comment: 'Screen Reader instructions'},
      ...
      'GreaterOrEquals': {id: 'GreaterOrEquals', value: 'より大か等しい', comment: 'Greater Or Equals in icons for filtering'},
      ...
      'JustifyCenter': {id: 'JustifyCenter', value: '中央揃え', comment: 'justify text to center in the editor'},
      'JustifyLeft': {id: 'JustifyLeft', value: '左に揃える', comment: 'justify text to left in the editor'},
      'JustifyRight': {id: 'JustifyRight', value: '右に揃える', comment: 'justify text to right in the editor'},
      ...
      'LessOrEquals': {id: 'LessOrEquals', value: 'より小か等しい', comment: 'Less Or Equals in icons for filtering'},
      ...
      'MapPin': {id: 'MapPin', value: 'マップのピン', comment: 'Map Pin tooltip'},
      ...
      'MingleShare': {id: 'MingleShare', value: 'Ming.le を開始', comment: 'Share the contextual object/action in the mingle system'},
      ...
      'MultiselectWith': {id: 'MultiselectWith', value: '. 複数選択 ', comment: 'the minutes portion of a time'},
      ...
      'NumberList': {id: 'NumberList', value: '段落番号', comment: 'Number List tooltip'},
      'OpenBackClose': {id: 'OpenBackClose', value: 'オープン / 戻る / 閉じる', comment: 'Open / Back / Close tooltip'},
      'OpenClose': {id: 'OpenClose', value: 'オープン / 閉じる', comment: 'Open / Close tooltip'},
      'OrderedList': {id: 'OrderedList', value: '番号付きリスト', comment: 'Insert an Ordered list in the editor'},
      ...
      'PasswordValidation': {id: 'PasswordValidation', value: '<div class="password-Tooltip"><strong>パスワードは次の要件を満たす必要があります。</strong><ul><li>長さは 10 文字以上にする</li><li>大文字を最低 1 字含む</li><li>小文字を最低 1 字を含む</li><li><strong>特殊文字を 1 字を含む</strong></li><li>自分のユーザー名を含まない</li><li>以前に使用したパスワードでない</li></ul></div>', comment: 'Password validation requirements'},
      ...
      'RightAlignText': {id: 'RightAlignText', value: 'テキスト右揃え', comment: 'Right Align Text tooltip'},
      ...
      'SearchFolder': {id: 'SearchFolder', value: 'フォルダーの検索', comment: 'Search Folder tooltip'},
      ...
      'SortAtoZ': {id: 'SortAtoZ', value: '並べ替え A ～ Z', comment: 'Sort A to Z in icons for filtering'},
      'SortZtoA': {id: 'SortZtoA', value: '並べ替え Z ～ A', comment: 'Sort Z to A in icons for filtering'},
      ...
      'Tack': {id: 'Tack', value: 'ピン', comment: 'Tack tooltip'},
      ...
      'UnorderedList': {id: 'UnorderedList', value: '記号付きリスト', comment: 'Insert an Unordered list in the editor'},
      ...
      'VerticalMiddleAlign': {id: 'VerticalMiddleAlign', value: '上下中央揃え', comment: 'Vertical Middle Align tooltip'},
