(function (factory) {
  ...
  Locale.addCulture('da-DK', {
    ...
    messages: {
      ...
      'AdvancedFilter': {id: 'AdvancedFilter', value: 'Opret avanceret filer', comment: 'In a data grid active an advanced filtering feature'},
      ...
      'Bookmarked': {id: 'Bookmarked', value: 'Bogmærke oprettet', comment: 'Bookmark filled'},
      'BookmarkThis': {id: 'BookmarkThis', value: 'Bogmærk dette', comment: 'Bookmark outlined'},
      ...
      'CharactersLeft': {id: 'CharactersLeft', value: 'Tegn tilbage ', comment: 'indicator showing how many more characters you can type.'},
      ...
      'Drilldown': {id: 'Drilldown', value: 'Analyser ned', comment: 'Drill by moving page flow into a record'},
      'Drillup': {id: 'Drillup', value: 'Analyser op', comment: 'Opposite of Drilldown, move back up to a larger set of records'},
      ...
      'GreaterOrEquals': {id: 'GreaterOrEquals', value: 'Større end eller lig med', comment: 'Greater Or Equals in icons for filtering'},
      ...
      'MapPin': {id: 'MapPin', value: 'Kortikon', comment: 'Map Pin tooltip'},
      ...
      'MultiselectWith': {id: 'MultiselectWith', value: '. Vælg flere med ', comment: 'the minutes portion of a time'},
      ...
      'OrderedList': {id: 'OrderedList', value: 'Ordnet liste', comment: 'Insert an Ordered list in the editor'},
      ...
      'PressDown': {id: 'PressDown', value: 'Tryk ned for at vælge en dato', comment: 'the audible label for Tooltip about how to operate the date picker'},
      ...
      'Right': {id: 'Right', value: 'Højre', comment: 'Right tooltip'},
      'RightAlign': {id: 'RightAlign', value: 'Højrejusteret', comment: 'Right Align tooltip'},
      'RightAlignText': {id: 'RightAlignText', value: 'Højrejuster tekst', comment: 'Right Align Text tooltip'},
      ...
      'SortAtoZ': {id: 'SortAtoZ', value: 'Sorter A til Å', comment: 'Sort A to Z in icons for filtering'},
      ...
      'UnorderedList': {id: 'UnorderedList', value: 'Uordnet liste', comment: 'Insert an Unordered list in the editor'},
      ...
      'VerticalMiddleAlign': {id: 'VerticalMiddleAlign', value: 'Juster midt på lodret', comment: 'Vertical Middle Align tooltip'},
