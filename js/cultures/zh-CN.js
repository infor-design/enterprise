(function (factory) {
  ...
  Locale.addCulture('zh-CN', {
    ...
    messages: {
      ...
      'Bookmarked': {id: 'Bookmarked', value: '已做书签', comment: 'Bookmark filled'},
      ...
      'FileUpload': {id: 'FileUpload', value: '文件上传，按 Enter 以浏览文件', comment: 'Screen Reader instructions'},
      ...
      'MapPin': {id: 'MapPin', value: '标记', comment: 'Map Pin tooltip'},
      ...
      'OrderedList': {id: 'OrderedList', value: '排序列表', comment: 'Insert an Ordered list in the editor'},
      ...
      'PasswordValidation': {id: 'PasswordValidation', value: '<div class="password-Tooltip"密码必须:</strong><ul><li>至少有 10 个字符</li><li>至少有一个大写字符</li><li>至少有一个消息字符</li><li><strong>包含一个特殊字符</strong></li><li>不包含您的用户名</li><li>不能是先前使用过的密码</li></ul></div>', comment: 'Password validation requirements'},
      ...
      'RightAlignText': {id: 'RightAlignText', value: '文本右对齐', comment: 'Right Align Text tooltip'},
      ...
      'SortAtoZ': {id: 'SortAtoZ', value: '从 A 到 Z 排序', comment: 'Sort A to Z in icons for filtering'},
      'SortZtoA': {id: 'SortZtoA', value: '从 Z 到 A 排序', comment: 'Sort Z to A in icons for filtering'},
      ...
      'Tack': {id: 'Tack', value: '标记', comment: 'Tack tooltip'},
      ...
      'UnorderedList': {id: 'UnorderedList', value: '未排序列表', comment: 'Insert an Unordered list in the editor'},
      ...
      'VerticalMiddleAlign': {id: 'VerticalMiddleAlign', value: '垂直居中对齐', comment: 'Vertical Middle Align tooltip'},
