(function (factory) {
  ...
  Locale.addCulture('es-ES', {
    ...
    messages: {
      ...
      'Bookmarked': {id: 'Bookmarked', value: 'Señalado con marcador', comment: 'Bookmark filled'},
      ...
      'JustifyLeft': {id: 'JustifyLeft', value: 'Justificar a la izquierda', comment: 'justify text to left in the editor'},
      'JustifyRight': {id: 'JustifyRight', value: 'Justificar a la derecha', comment: 'justify text to right in the editor'},
      ...
      'MapPin': {id: 'MapPin', value: 'Marcar en mapa', comment: 'Map Pin tooltip'},
      ...
      'MultiselectWith': {id: 'MultiselectWith', value: '. Selección múltiple con ', comment: 'the minutes portion of a time'},
      ...
      'OrderedList': {id: 'OrderedList', value: 'Lista numerada', comment: 'Insert an Ordered list in the editor'},
      ...
      'PasswordValidation': {id: 'PasswordValidation', value: '<div class="password-Tooltip"><strong>Requisitos de la contraseña :</strong><ul><li>Debe tener como mínimo 10 caracteres</li><li>Debe incluir como mínimo una mayúscula</li><li>Debe incluir como mínimo una minúscula</li><li><strong>Debe incluir un carácter especial</strong></li><li>No debe incluir el nombre del usuario</li><li>No puede ser una contraseña utilizada anteriormente</li></ul></div>', comment: 'Password validation requirements'},
      ...
      'PressDown': {id: 'PressDown', value: 'Pulse Flecha abajo para seleccionar una fecha', comment: 'the audible label for Tooltip about how to operate the date picker'},
      ...
      'Right': {id: 'Right', value: 'Derecha', comment: 'Right tooltip'},
      'RightAlign': {id: 'RightAlign', value: 'Alinear a la derecha', comment: 'Right Align tooltip'},
      'RightAlignText': {id: 'RightAlignText', value: 'Alinear texto a la derecha', comment: 'Right Align Text tooltip'},
      ...
      'SortAtoZ': {id: 'SortAtoZ', value: 'Orden A-Z', comment: 'Sort A to Z in icons for filtering'},
      'SortZtoA': {id: 'SortZtoA', value: 'Orden Z-A', comment: 'Sort Z to A in icons for filtering'},
      ...
      'Tack': {id: 'Tack', value: 'Marca', comment: 'Tack tooltip'},
      ...
      'UnorderedList': {id: 'UnorderedList', value: 'Lista con viñetas', comment: 'Insert an Unordered list in the editor'},
      ...
      'VerticalMiddleAlign': {id: 'VerticalMiddleAlign', value: 'Alinear verticalmente en centro', comment: 'Vertical Middle Align tooltip'},
