(function (factory) {
  ...
  Locale.addCulture('zh-TW', {
    ...
    messages: {
      ...
      'EndWith': {id: 'EndWith', value: '結尾為', comment: 'for condition filtering'},
      ...
      'PasswordValidation': {id: 'PasswordValidation', value: '<strong>密碼長度</strong><br>至少必須為 10 個字元<br>至少具有一個大寫字元<br>至少必須具有一個小寫字元<br>包含一個特殊字元<br>不包含您的使用者名稱<br>不得為之前使用過的密碼<br>', comment: 'Password validation requirements'},
      ...
      'StartWith': {id: 'StartWith', value: '開頭為', comment: 'for condition filtering'},
