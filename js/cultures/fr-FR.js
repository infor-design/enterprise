(function (factory) {
  ...
  Locale.addCulture('fr-FR', {
    ...
    messages: {
      ...
      'Bookmarked': {id: 'Bookmarked', value: 'Signet ajouté', comment: 'Bookmark filled'},
      'BookmarkThis': {id: 'BookmarkThis', value: 'Mettre un signet', comment: 'Bookmark outlined'},
      ...
      'CharactersLeft': {id: 'CharactersLeft', value: 'Caractères restants ', comment: 'indicator showing how many more characters you can type.'},
      ...
      'GreaterOrEquals': {id: 'GreaterOrEquals', value: 'Supérieur ou égal', comment: 'Greater Or Equals in icons for filtering'},
      ...
      'JustifyLeft': {id: 'JustifyLeft', value: 'Aligner à gauche', comment: 'justify text to left in the editor'},
      'JustifyRight': {id: 'JustifyRight', value: 'Aligner à droite', comment: 'justify text to right in the editor'},
      ...
      'LessOrEquals': {id: 'LessOrEquals', value: 'Inférieur ou égal', comment: 'Less Or Equals in icons for filtering'},
      ...
      'MapPin': {id: 'MapPin', value: 'Epingler', comment: 'Map Pin tooltip'},
      ...
      'MultiselectWith': {id: 'MultiselectWith', value: '. Sélection multiple avec ', comment: 'the minutes portion of a time'},
      ...
      'OrderedList': {id: 'OrderedList', value: 'Liste numérotée', comment: 'Insert an Ordered list in the editor'},
      ...
      'PasswordValidation': {id: 'PasswordValidation', value: '<div class="password-Tooltip"><strong>Le mot de passe :</strong><ul><li>doit avoir au moins 10 caractères</li><li>doit avoir au moins une lettre majuscule</li><li>doit avoir au moins une lettre minuscule</li><li><strong>doit contenir un caractère spécial</strong></li><li>ne doit pas contenir votre nom d\'utilisateur</li><li>ne doit pas être un mot de passe utilisé précédemment</li></ul></div>', comment: 'Password validation requirements'},
      ...
      'PressDown': {id: 'PressDown', value: 'Appuyez pour sélectionner une date', comment: 'the audible label for Tooltip about how to operate the date picker'},
      ...
      'RecordsPerPage': {id: 'RecordsPerPage', value: '{0} enregistrements par page', comment: 'Dropd own allows the user to select how many visible records {} shows select value.'},
      ...
      'RightAlignText': {id: 'RightAlignText', value: 'Alignement de texte à droite', comment: 'Right Align Text tooltip'},
      ...
      'SortAtoZ': {id: 'SortAtoZ', value: 'Tri de A à Z', comment: 'Sort A to Z in icons for filtering'},
      'SortZtoA': {id: 'SortZtoA', value: 'Tri de Z à A', comment: 'Sort Z to A in icons for filtering'},
      ...
      'Tack': {id: 'Tack', value: 'Punaise', comment: 'Tack tooltip'},
      ...
      'UnorderedList': {id: 'UnorderedList', value: 'Liste à puces', comment: 'Insert an Unordered list in the editor'},
      ...
      'VerticalMiddleAlign': {id: 'VerticalMiddleAlign', value: 'Alignement centré vertical', comment: 'Vertical Middle Align tooltip'},
