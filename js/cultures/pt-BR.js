(function (factory) {
  ...
  Locale.addCulture('pt-BR', {
    ...
    messages: {
      ...
      'Bookmarked': {id: 'Bookmarked', value: 'Marcado com indicador', comment: 'Bookmark filled'},
      'BookmarkThis': {id: 'BookmarkThis', value: 'Indicar esta', comment: 'Bookmark outlined'},
      ...
      'Checked': {id: 'Checked', value: 'Verificado', comment: 'Checked tooltip'},
      ...
      'DoesNotEqual': {id: 'DoesNotEqual', value: 'Não é igual à', comment: 'Does Not Equal in icons for filtering'},
      ...
      'Equals': {id: 'Equals', value: 'É igual à', comment: 'Equals in icons for filtering'},
      ...
      'GreaterOrEquals': {id: 'GreaterOrEquals', value: 'Maior ou Igual', comment: 'Greater Or Equals in icons for filtering'},
      ...
      'JustifyLeft': {id: 'JustifyLeft', value: 'Justificar à esquerda', comment: 'justify text to left in the editor'},
      'JustifyRight': {id: 'JustifyRight', value: 'Justificar à direita', comment: 'justify text to right in the editor'},
      ...
      'LessOrEquals': {id: 'LessOrEquals', value: 'É menor ou igual', comment: 'Less Or Equals in icons for filtering'},
      ...
      'MapPin': {id: 'MapPin', value: 'Marcar no mapa', comment: 'Map Pin tooltip'},
      ...
      'MultiselectWith': {id: 'MultiselectWith', value: '. Seleção múltipla com ', comment: 'the minutes portion of a time'},
      ...
      'OrderedList': {id: 'OrderedList', value: 'Lista ordenada', comment: 'Insert an Ordered list in the editor'},
      ...
      'PasswordValidation': {id: 'PasswordValidation', value: '<div class=”password-Tooltip”><strong>A senha deve:</strong><ul><li>conter pelo menos 10 caracteres</li><li>conter pelo menos um caractere maiúsculo</li><li>conter pelo menos um caractere minúsculo</li><li><strong>conter um caractere especial</strong></li><li>não conter o seu nome de usuário</li><li>não pode ser uma senha que tenha sido usada</li></ul></div>', comment: 'Password validation requirements'},
      ...
      'Right': {id: 'Right', value: 'Direita', comment: 'Right tooltip'},
      'RightAlign': {id: 'RightAlign', value: 'Alinhar à direita', comment: 'Right Align tooltip'},
      'RightAlignText': {id: 'RightAlignText', value: 'Alinha texto à direita', comment: 'Right Align Text tooltip'},
      ...
      'SearchFolder': {id: 'SearchFolder', value: 'Pesquisar na pasta', comment: 'Search Folder tooltip'},
      ...
      'SortAtoZ': {id: 'SortAtoZ', value: 'Classificar de A-Z', comment: 'Sort A to Z in icons for filtering'},
      'SortZtoA': {id: 'SortZtoA', value: 'Classificar de Z-A', comment: 'Sort Z to A in icons for filtering'},
      ...
      'Tack': {id: 'Tack', value: 'Tachado', comment: 'Tack tooltip'},
      ...
      'UnorderedList': {id: 'UnorderedList', value: 'Lista não ordenada', comment: 'Insert an Unordered list in the editor'},
      ...
      'VerticalMiddleAlign': {id: 'VerticalMiddleAlign', value: 'Alinhar verticalmente ao centro', comment: 'Vertical Middle Align tooltip'},
