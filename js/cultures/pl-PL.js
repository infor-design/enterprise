(function (factory) {
  ...
  Locale.addCulture('pl-PL', {
    ...
    messages: {
      'AboutText': {id: 'AboutText', value: 'Copyright &copy; {0} Infor.  Wszelkie prawa zastrzeżone. Słowa i znaki projektowe zawarte w niniejszym dokumencie są znakami towarowymi i/lub zastrzeżonymi znakami towarowymi firmy Infor i/lub jej filii i oddziałów. Wszelkie prawa zastrzeżone. Wszystkie inne znaki towarowe wymienione w niniejszym dokumencie są własnością odpowiednich właścicieli.'},
      ...
      'AdvancedFilter': {id: 'AdvancedFilter', value: 'Utwórz zaawansowany filtr', comment: 'In a data grid active an advanced filtering feature'},
      ...
      'Azure': {id: 'Azure', value: 'Azurowy', comment: 'Color in our color pallette'},
      ...
      'Bold': {id: 'Bold', value: 'Pogrubiony', comment: 'Make text Bold'},
      'Bookmarked': {id: 'Bookmarked', value: 'Dodane do zakładek', comment: 'Bookmark filled'},
      'BookmarkThis': {id: 'BookmarkThis', value: 'Dodaj do zakładek', comment: 'Bookmark outlined'},
      ...
      'CharactersLeft': {id: 'CharactersLeft', value: 'Pozostałe znaki ', comment: 'indicator showing how many more characters you can type.'},
      'CharactersMax': {id: 'CharactersMax', value: 'Maksymalna liczba znaków dla ', comment: 'indicator showing how many max characters you can type.'},
      ...
      'Checked': {id: 'Checked', value: 'Zaznaczony', comment: 'Checked tooltip'},
      ...
      'Completed': {id: 'Completed', value: 'Zakończone', comment: 'Text For a Completed Status'},
      ...
      'EitherSelectedOrNotSelected': {id: 'EitherSelectedOrNotSelected', value: 'Zaznaczone lub niezaznaczone', comment: 'Either Selected Or NotSelected in icons for filtering'},
      'EnterComments': {id: 'EnterComments', value: 'Wprowadź tutaj komentarz...', comment: 'Placeholder text for a text input (comments)'},
      ...
      'ExportAsSpreadsheet': {id: 'ExportAsSpreadsheet', value: 'Eksportuj arkusz kalkulacyjny', comment: 'Export as Spreadsheet tooltip'},
      ...
      'FileUpload': {id: 'FileUpload', value: 'Przekazywanie pliku. Naciśnij klawisz Enter, aby przejść do pliku', comment: 'Screen Reader instructions'},
      ...
      'FullView': {id: 'FullView', value: 'Pełny widok', comment: 'Full View tooltip'},
      'GoForward': {id: 'GoForward', value: 'Przejdź dalej', comment: 'Move Page / object this direction'},
      'GoBack': {id: 'GoBack', value: 'Wstecz', comment: 'Move Page / object this directionp'},
      ...
      'GreaterOrEquals': {id: 'GreaterOrEquals', value: 'Większe lub równe', comment: 'Greater Or Equals in icons for filtering'},
      ...
      'JustifyCenter': {id: 'JustifyCenter', value: 'Wyjustuj do środka', comment: 'justify text to center in the editor'},
      'JustifyLeft': {id: 'JustifyLeft', value: 'Wyjustuj do lewej', comment: 'justify text to left in the editor'},
      'JustifyRight': {id: 'JustifyRight', value: 'Wyjustuj do prawej', comment: 'justify text to right in the editor'},
      ...
      'LessOrEquals': {id: 'LessOrEquals', value: 'Mniejsze lub równe', comment: 'Less Or Equals in icons for filtering'},
      ...
      'Lowest': {id: 'Lowest', value: 'Najniższe', comment: 'Lowest - As in Lowest value'},
      ...
      'MultiselectWith': {id: 'MultiselectWith', value: '. Wybór wielokrotny za pomocą ', comment: 'the minutes portion of a time'},
      ...
      'NextMonth': {id: 'NextMonth', value: 'W przyszłym miesiącu', comment: 'the label for the button that moves calendar to next/prev'},
      'NoResults': {id: 'NoResults', value: 'Brak wyników', comment: 'Search Results Text'},
      'Notes': {id: 'Notes', value: 'Uwagi', comment: 'Notes icon tooltip'},
      ...
      'OrderedList': {id: 'OrderedList', value: 'Lista uporządkowana', comment: 'Insert an Ordered list in the editor'},
      ...
      'PasswordValidation': {id: 'PasswordValidation', value: 'Prawidłowe hasło musi zawierać co najmniej 10 znaków, w tym co najmniej jedną wielką literę, jedną małą literę i jeden znak specjalny. Hasło nie może zawierać nazwy użytkownika i nie może być poprzednim hasłem.', comment: 'Password validation requirements'},
      ...
      'PressDown': {id: 'PressDown', value: 'Kliknij strzałkę w dół, aby wybrać datę', comment: 'the audible label for Tooltip about how to operate the date picker'},
      ...
      'Previous': {id: 'Previous', value: 'Poprzednie', comment: 'Previous icon tooltip - moved to previous record'},
      ...
      'Right': {id: 'Right', value: 'W prawo', comment: 'Right tooltip'},
      'RightAlign': {id: 'RightAlign', value: 'Wyrównaj do prawej', comment: 'Right Align tooltip'},
      'RightAlignText': {id: 'RightAlignText', value: 'Wyrównaj tekst do prawej', comment: 'Right Align Text tooltip'},
      ...
      'Ruby': {id: 'Ruby', value: 'Dopisek fonetyczny', comment: 'Color in our color pallette'},
      ...
      'SearchFolder': {id: 'SearchFolder', value: 'Przeszukaj folder', comment: 'Search Folder tooltip'},
      ...
      'Short': {id: 'Short', value: 'Krótki', comment: 'Describes a Shorted Row Height in a grid/list'},
      'Slate': {id: 'Slate', value: 'Łupkowy', comment: 'Color in our color pallette'},
      ...
      'SliderMaximumHandle': {id: 'SliderMaximumHandle', value: 'Maksymalny uchwyt zakresu dla', comment: 'Describes a maximum value handle in a Range (double slider), followed in code by the name of the control'},
      'SliderMinimumHandle': {id: 'SliderMinimumHandle', value: 'Minimalny uchwyt zakresu dla', comment: 'Describes a minimum value handle in a Range (double slider), followed in code by the name of the control'},
      ...
      'SortAtoZ': {id: 'SortAtoZ', value: 'Sortuj od A do Z', comment: 'Sort A to Z in icons for filtering'},
      'SortZtoA': {id: 'SortZtoA', value: 'Sortuj od Z do A', comment: 'Sort Z to A in icons for filtering'},
      ...
      'Tack': {id: 'Tack', value: 'Przypnij', comment: 'Tack tooltip'},
      ...
      'Upload': {id: 'Upload', value: 'Prześlij', comment: 'Upload tooltip'},
      'UnavailableDate': {id: 'UnavailableDate', value: 'Niedostępna data', comment: 'Unavailable Date Text'},
      ...
      'UnorderedList': {id: 'UnorderedList', value: 'Lista nieuporządkowana', comment: 'Insert an Unordered list in the editor'},
      'Unsupported': {id: 'Unsupported', value: 'Zawartość jest niedostępna, ponieważ ma funkcje, które nie są obsługiwane przez Twoją bieżącą wersję przeglądarki.', comment: 'Suggesting browser upgrade for missing features.'},
      'Url': {id: 'Url', value: 'Adres URL', comment: 'Url tooltip'},
      'UseArrow': {id: 'UseArrow', value: '. Użyj klawiszy strzałek do wybierania.', comment: 'Instructional comments for screen readers'},
      'UseEnter': {id: 'UseEnter', value: '. Użyj strzałki W dół do wyszukiwania.', comment: 'Instructional comments for screen readers'},
      ...
      'VerticalMiddleAlign': {id: 'VerticalMiddleAlign', value: 'Wyrównaj do środka w pionie', comment: 'Vertical Middle Align tooltip'},
