(function (factory) {
  ...
  Locale.addCulture('hr-HR', {
    ...
    messages: {
      ...
      'Bookmarked': {id: 'Bookmarked', value: 'S knjižnom oznakom', comment: 'Bookmark filled'},
      'BookmarkThis': {id: 'BookmarkThis', value: 'Dodaju knjižnu oznaku', comment: 'Bookmark outlined'},
      ...
      'EnterComments': {id: 'EnterComments', value: 'Unesi komentare ovdje...', comment: 'Placeholder text for a text input (comments)'},
      ...
      'FileUpload': {id: 'FileUpload', value: 'Prijenos datoteke, za opciju Pretraživanje datoteke pritisni tipku Unos', comment: 'Screen Reader instructions'},
      ...
      'GreaterOrEquals': {id: 'GreaterOrEquals', value: 'Veće od ili jednako', comment: 'Greater Or Equals in icons for filtering'},
      ...
      'InvalidDate': {id: 'InvalidDate', value: 'Datumi nije valjan', comment: 'validation message for wrong date format (short)'},
      ...
      'JustifyCenter': {id: 'JustifyCenter', value: 'Poravnaj na sredini', comment: 'justify text to center in the editor'},
      ...
      'LeftAlign': {id: 'LeftAlign', value: 'Poravnaj slijeva', comment: 'Left Align tooltip'},
      'LeftTextAlign': {id: 'LeftTextAlign', value: 'Poravnaj tekst slijeva', comment: 'Left Text Align tooltip'},
      'LessOrEquals': {id: 'LessOrEquals', value: 'Manje od ili jednako', comment: 'Less Or Equals in icons for filtering'},
      ...
      'MultiselectWith': {id: 'MultiselectWith', value: '. Višestruki odabir s pomoću ', comment: 'the minutes portion of a time'},
      ...
      'OrderedList': {id: 'OrderedList', value: 'Numerirani popis', comment: 'Insert an Ordered list in the editor'},
      ...
      'RecordsPerPage': {id: 'RecordsPerPage', value: '{0} Zapisi po stranici', comment: 'Dropd own allows the user to select how many visible records {} shows select value.'},
      ...
      'Right': {id: 'Right', value: 'Desno', comment: 'Right tooltip'},
      'RightAlign': {id: 'RightAlign', value: 'Poravnaj zdesna', comment: 'Right Align tooltip'},
      'RightAlignText': {id: 'RightAlignText', value: 'Poravnaj tekst zdesna', comment: 'Right Align Text tooltip'},
      ...
      'SearchFolder': {id: 'SearchFolder', value: 'Pretraži mapu', comment: 'Search Folder tooltip'},
      ...
      'SortAtoZ': {id: 'SortAtoZ', value: 'Sortiraj od A do Z', comment: 'Sort A to Z in icons for filtering'},
      'SortZtoA': {id: 'SortZtoA', value: 'Sortiraj od Z do A', comment: 'Sort Z to A in icons for filtering'},
      ...
      'Tack': {id: 'Tack', value: 'Pribadača', comment: 'Tack tooltip'},
      ...
      'UnorderedList': {id: 'UnorderedList', value: 'Nenumerirani popis', comment: 'Insert an Unordered list in the editor'},
      ...
      'VerticalMiddleAlign': {id: 'VerticalMiddleAlign', value: 'Poravnaj vertikalno po sredini', comment: 'Vertical Middle Align tooltip'},
