(function (factory) {
  ...
  Locale.addCulture('id-ID', {
    ...
    messages: {
      ...
      'PressDown': {id: 'PressDown', value: 'Tekan Turun panah untuk memilih tanggal', comment: 'the audible label for Tooltip about how to operate the date picker'},
      ...
      'StartWith': {id: 'StartWith', value: 'Mulai Dengan', comment: 'for condition filtering'},
