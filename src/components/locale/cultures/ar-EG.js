...
Soho.Locale.addCulture('ar-EG', {
  ...
  messages: {
    ...
    Blockquote: { id: 'Blockquote', value: 'اقتباس كتلة', comment: 'Term for Block Quotations in editing' },
    ...
    Locale: { id: 'Locale', value: 'الإعدادات المحلية', comment: 'A place or locality for example en-US, it-It ect' },
