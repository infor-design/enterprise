...
Soho.Locale.addCulture('ar-EG', {
  ...
  messages: {
    ...
    EarlyOrUntil: { id: 'EarlyOrUntil', value: 'أقدم من أو حتى', comment: 'Earlier than or equals in icons for filtering' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'قم بالسحب والإفلات هنا أو <span class="hyperlink">تحميل الملفات</span> المراد تحميلها', comment: 'Updated recently' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'قم بالسحب والإفلات هنا لتحميل الملفات', comment: 'New' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>خطأ</em> لا يمكن تحميل أكثر من الحد الأقصى لعدد الملفات ({maxFiles})', comment: 'New' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>خطأ</em> تم تجاوز الحد الأقصى لعدد الملفات المسموح به', comment: 'New' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>خطأ</em> تم تجاوز حد حجم الملف', comment: 'New' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>خطأ</em> نوع الملف غير مسموح به', comment: 'New' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>خطأ</em> لم يتم العثور على عنوان URL', comment: 'New' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>خطأ</em> يجب أن تكون رؤوس الطلب عبارة عن سلسلة JSON صالحة', comment: 'New' },
    UploadLink: { id: 'UploadLink', value: 'تحميل الملفات', comment: 'New' },
    UploadCancel: { id: 'UploadCancel', value: 'إلغاء تحميل هذا الملف', comment: 'New' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'إلغاء الكل', comment: 'New' },
    UploadDismissError: { id: 'UploadDismissError', value: 'تجاهل هذا الخطأ', comment: 'New' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} تم تحميل {loaded} من {size} ({percent}%)', comment: 'New - contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'إزالة هذا الملف', comment: 'New' },
    UploadStart: { id: 'UploadStart', value: 'بدء تحميل هذا الملف', comment: 'New' },
