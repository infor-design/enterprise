...
Soho.Locale.addCulture('ar-EG', {
  ...
  messages: {
    ...
    GroupsPerPage: { id: 'GroupsPerPage', value: '{0} مجموعة/مجموعات بكل صفحة', comment: 'Dropdown allows the user to select how many visible Groups the {} placeholder shows value.' },
    ...
    Large: { id: 'Large', value: 'كبير', comment: 'A larger row sizes with taller rows' },
    ...
    Show: { id: 'Show', value: 'تبين', comment: 'On a Button for revealing text that is hidden' },
