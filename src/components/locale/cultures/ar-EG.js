...
Soho.Locale.addCulture('ar-EG', {
  ...
  messages: {
    ...
    CharactersMax: { id: 'CharactersMax', value: 'الحد الأقصى لعدد الأحرف هو {0}', comment: 'indicator showing how many max characters you can type.' },
    ...
    Go: { id: 'Go', value: 'انتقال', comment: 'Go, perform a movement, start a search, move to the next object in a workflow.' },
