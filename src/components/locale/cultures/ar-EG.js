...
Soho.Locale.addCulture('ar-EG', {
  ...
  messages: {
    ...
    ResultOf: { id: 'ResultOf', value: '{0} نتيجة من {1}', comment: 'Text Showing current and total number of Result' },
    ResultsOf: { id: 'ResultsOf', value: '{0} نتائج من {1}', comment: 'Text Showing current and total number of Results' },
