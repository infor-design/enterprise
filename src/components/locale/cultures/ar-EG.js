...
Soho.Locale.addCulture('ar-EG', {
  ...
  messages: {
    ...
    Blockquote: { id: 'Blockquote', value: 'كتلة نصية مقتبسة', comment: 'Term for Block Quotations in editing (please check this for thai see https://github.com/infor-design/enterprise/issues/4738)' },
    ...
    ClearFilter: { id: 'ClearFilter', value: 'مسح عامل التصفية', comment: 'Clear the current filter criteria - plese check this for greek https://github.com/infor-design/enterprise/issues/4791' },
