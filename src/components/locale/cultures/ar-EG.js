...
Soho.Locale.addCulture('ar-EG', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'زر طي التقسيم', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'سحب مقبض التقسيم', comment: 'Drags the splitter handle' },
