...
Soho.Locale.addCulture('ar-EG', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} سجل/سجلات لكل صفحة', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
