...
Soho.Locale.addCulture('ar-EG', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'اختر ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'اختر ', comment: 'Audible tooltip for choosing an item in a list.' },
