...
Soho.Locale.addCulture('zh-TW', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: '分隔器折疊按鈕', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: '分隔器拖拽控點', comment: 'Drags the splitter handle' },
