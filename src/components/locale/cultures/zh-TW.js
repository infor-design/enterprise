...
Soho.Locale.addCulture('zh-TW', {
  ...
  messages: {
    ...
    AppMenuTriggerTextAlt: { id: 'AppMenuTriggerTextAlt', value: '應用程式功能表觸發程序', comment: 'Default text used inside of Application Menu trigger buttons' },
    ...
    DatePickerTriggerButton: { id: 'DatePickerTriggerButton', value: '日期選擇器觸發程序', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
    ...
    LookupTriggerButton: { id: 'LookupTriggerButton', value: '查閱觸發程序', comment: 'Used in accessible labels to describe a lookup field\'s trigger button to assistive technology' },
    ...
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: '時間選擇器觸發程序', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
