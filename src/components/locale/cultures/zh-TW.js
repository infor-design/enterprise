...
Soho.Locale.addCulture('zh-TW', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: '選擇 ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: '選擇 ', comment: 'Audible tooltip for choosing an item in a list.' },
