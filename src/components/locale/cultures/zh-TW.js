...
Soho.Locale.addCulture('zh-TW', {
  ...
  messages: {
    ...
    Blockquote: { id: 'Blockquote', value: '區塊引述', comment: 'Term for Block Quotations in editing (please check this for thai see https://github.com/infor-design/enterprise/issues/4738)' },
    ...
    ClearFilter: { id: 'ClearFilter', value: '清除篩選', comment: 'Clear the current filter criteria - plese check this for greek https://github.com/infor-design/enterprise/issues/4791' },
    ...
    Highlight: { id: 'Highlight', value: '醒目提示', comment: 'Used to highlight (select) a chart item' },
