...
Soho.Locale.addCulture('zh-TW', {
  ...
  messages: {
    ...
    NewItem: { id: 'NewItem', value: '新項目', comment: 'New item in listbuilder' },
    NewWindow: { id: 'NewWindow', value: '新視窗', comment: 'Contents open in a new browser window.' },
    ...
    UpComingEvents: { id: 'UpComingEvent', value: '即將到來的事件', comment: 'List of upcoming calendar events' },
