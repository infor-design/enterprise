...
Soho.Locale.addCulture('zh-TW', {
  ...
  messages: {
    ...
    English: { id: 'English', value: '英文 (澳大利亞)', comment: 'Language name for English' },
    ...
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: '觸發時間選擇器', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
