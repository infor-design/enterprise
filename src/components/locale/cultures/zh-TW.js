...
Soho.Locale.addCulture('zh-TW', {
  ...
  messages: {
    ...
    ExtraSmall: { id: 'ExtraSmall', value: '超小', comment: 'A smaller font size and compressed mode for datagrid rows. NOTE: Please change french to Très petite (Masculine form)' },
