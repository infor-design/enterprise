...
Soho.Locale.addCulture('lt-LT', {
  ...
  messages: {
    ...
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Laiko parinkiklio paleidiklis', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
