...
Soho.Locale.addCulture('lt-LT', {
  ...
  messages: {
    ...
    DoesNotEqual: { id: 'DoesNotEqual', value: 'Neatitinka', comment: 'Does Not Equal in icons for filtering' },
    ...
    Equals: { id: 'Equals', value: 'Atitinka', comment: 'Equals in icons for filtering' },
    ...
    InsertHyperlink: { id: 'InsertHyperlink', value: 'Įterpti hipersaitą', comment: 'Insert a hyperlink in an editor' },
    ...
    MoveToLeft: { id: 'MoveToLeft', value: 'Perkelti į kairę', comment: 'Button tooltip used in a list of movable items' },
    MoveToRight: { id: 'MoveToRight', value: 'Perkelti į dešinę', comment: 'Button tooltip used in a list of movable items' },
    ...
    Result: { id: 'Result', value: '‎(‏{0}‎ rezult.)', comment: 'Showing a single result in a List' },
    Results: { id: 'Results', value: '‎(‏{0}‎ rezult.)', comment: 'As in showing N Results (plural) in a List' },
    ResultOf: { id: 'ResultOf', value: '{0}‎ rezult. iš ‎{1}', comment: 'Text Showing current and total number of Result' },
    ResultsOf: { id: 'ResultsOf', value: '{0}‎ rezult. iš ‎{1}', comment: 'Text Showing current and total number of Results' },
