...
Soho.Locale.addCulture('lt-LT', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Skirstytuvo sutraukimo mygtukas', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Skirstytuvo vilkimo rankena', comment: 'Drags the splitter handle' },
