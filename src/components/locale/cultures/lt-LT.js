...
Soho.Locale.addCulture('lt-LT', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} įrašai (-ų) puslapyje', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
