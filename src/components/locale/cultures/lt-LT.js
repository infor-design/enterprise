...
Soho.Locale.addCulture('lt-LT', {
  ...
  messages: {
    ...
    AreaChart: { id: 'AreaChart', value: 'Sritinė diagrama', comment: 'A chart type' },
    ...
    English: { id: 'English', value: 'Anglų (Australija)', comment: 'Language name for English' },
    ...
    MonthWideLowerCaseApr: { id: 'MonthWideApr', value: 'Balandis', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseAug: { id: 'MonthWideAug', value: 'Rugpjūtis', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseDec: { id: 'MonthWideDec', value: 'Gruodis', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseFeb: { id: 'MonthWideFeb', value: 'Vasaris', comment: 'Month in Wide form  - in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJan: { id: 'MonthWideJan', value: 'Sausis', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJuly: { id: 'MonthWideJuly', value: 'Liepa', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJune: { id: 'MonthWideJune', value: 'Birželis', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseMar: { id: 'MonthWideMar', value: 'Kovas', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseMay: { id: 'MonthWideMay', value: 'Geg', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseNov: { id: 'MonthWideNov', value: 'Lapkritis', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseOct: { id: 'MonthWideOct', value: 'Spalis', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseSep: { id: 'MonthWideSep', value: 'Rugsėjis', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} įrašai (-ų) puslapyje', comment: 'Shows an actual number of pages in the pager' },
    ...
    Small: { id: 'Small', value: 'Mažas', comment: 'A more small grid setting for rows and sizes. NOTE: Please change french to Petite (Masculine form)' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Kad įkeltumėte, failus nuvilkite arba spustelėkite <span class=“hyperlink“>Pasirinkti failus</span>' },
    ...
    TimepickerPopup: { id: 'TimepickerPopup', value: 'Laiko parinkiklio iššokantysis langas', comment: 'text read out by assistive technology that explains that the user is interacting with a Timepicker popup.' },
