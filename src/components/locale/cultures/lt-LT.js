...
Soho.Locale.addCulture('lt-LT', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'Pasirinkite ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'Pasirinkite ', comment: 'Audible tooltip for choosing an item in a list.' },
