...
Soho.Locale.addCulture('lt-LT', {
  ...
  messages: {
    ...
    GroupsPerPage: { id: 'GroupsPerPage', value: '{0} Grupas vienā lappusē', comment: 'Dropdown allows the user to select how many visible Groups the {} placeholder shows value.' },
    ...
    Large: { id: 'Large', value: 'Liels', comment: 'A larger row sizes with taller rows' },
