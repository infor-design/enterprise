...
Soho.Locale.addCulture('he-IL', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'לחצן כיווץ מפצל', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'ידית אחיזה לגרירת מפצל', comment: 'Drags the splitter handle' },
