...
Soho.Locale.addCulture('he-IL', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} רשומות לעמוד', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
