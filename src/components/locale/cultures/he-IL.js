...
Soho.Locale.addCulture('he-IL', {
  ...
  messages: {
    ...
    EarlyOrEquals: { id: 'EarlyOrEquals', value: 'מוקדם יותר מ- או שווה ל-', comment: 'Earlier Than Or Equals in icons for filtering' },
    ...
    LaterOrEquals: { id: 'LaterOrEquals', value: 'מאוחר יותר מ- או שווה ל-', comment: 'Later Than Or Equals in icons for filtering' },
