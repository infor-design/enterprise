...
Soho.Locale.addCulture('pl-PL', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'Wybierz ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'Wybierz ', comment: 'Audible tooltip for choosing an item in a list.' },
