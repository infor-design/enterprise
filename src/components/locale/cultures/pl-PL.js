...
Soho.Locale.addCulture('pl-PL', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: 'Liczba rekordów na stronie: {0}', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
