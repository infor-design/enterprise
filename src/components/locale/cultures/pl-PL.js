...
Soho.Locale.addCulture('pl-PL', {
  ...
  messages: {
    ...
    GroupsPerPage: { id: 'GroupsPerPage', value: '{0} grup na stronie', comment: 'Dropdown allows the user to select how many visible Groups the {} placeholder shows value.' },
    ...
    Large: { id: 'Large', value: 'Duże', comment: 'A larger row sizes with taller rows' },
