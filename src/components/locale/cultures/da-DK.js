...
Soho.Locale.addCulture('da-DK', {
  ...
  messages: {
    ...
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Udløser for tidsvælger', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
