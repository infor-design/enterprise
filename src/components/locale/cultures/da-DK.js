...
Soho.Locale.addCulture('da-DK', {
  ...
  messages: {
    ...
    ExtraSmall: { id: 'ExtraSmall', value: 'Ekstra lille', comment: 'A smaller font size and compressed mode for datagrid rows. NOTE: Please change french to Très petite (Masculine form)' },
