...
Soho.Locale.addCulture('da-DK', {
  ...
  messages: {
    ...
    AreaChart: { id: 'AreaChart', value: 'Områdediagram', comment: 'A chart type' },
    ...
    BrowserLanguage: { id: 'BrowserLanguage', value: 'Browsersprog', comment: 'Language in the current Web Browser' },
    ...
    English: { id: 'English', value: 'Engelsk (Australien)', comment: 'Language name for English' },
    ...
    SelectedOptions: { id: 'SelectedOptions', value: 'Valgte muligheder', comment: 'shown on a list of selected dropdown options (generic)' },
    ...
    SetTime: { id: 'SetTime', value: 'Indstil tid', comment: 'button the sets time in a field' },
    ...
    Small: { id: 'Small', value: 'Lille', comment: 'A more small grid setting for rows and sizes. NOTE: Please change french to Petite (Masculine form)' },
    SohoDarkTheme: { id: 'SohoDarkTheme', value: 'Soho Mørk', comment: 'The name of an application Theme' },
    SohoHighContrastTheme: { id: 'SohoHighContrastTheme', value: 'Soho Høj kontrast', comment: 'The name of an application Theme' },
    SohoLightTheme: { id: 'SohoLightTheme', value: 'Soho Lys', comment: 'The name of an application Theme' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Træk og slip, eller <span class="hyperlink">vælg filer</span>, der skal overføres' },
    ...
    ViewVisual: { id: 'ViewVisual', value: 'Vis visuel', comment: 'Toggle between the source view and visual view' },
