...
Soho.Locale.addCulture('da-DK', {
  ...
  messages: {
    ...
    GroupsPerPage: { id: 'GroupsPerPage', value: '{0} Grupper pr. side', comment: 'Dropdown allows the user to select how many visible Groups the {} placeholder shows value.' },
    ...
    Large: { id: 'Large', value: 'Stor', comment: 'A larger row sizes with taller rows' },
