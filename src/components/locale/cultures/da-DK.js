...
Soho.Locale.addCulture('da-DK', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Knappen Skjul opdeling', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Opdelingshåndtag', comment: 'Drags the splitter handle' },
