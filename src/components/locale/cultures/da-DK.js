...
Soho.Locale.addCulture('da-DK', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} poster pr. side', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
