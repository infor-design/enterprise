...
Soho.Locale.addCulture('da-DK', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'Vælg en ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'Vælg en ', comment: 'Audible tooltip for choosing an item in a list.' },
