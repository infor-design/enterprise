...
Soho.Locale.addCulture('de-DE', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} Datensätze pro Seite', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
