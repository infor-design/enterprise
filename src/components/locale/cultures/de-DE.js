...
Soho.Locale.addCulture('de-DE', {
  ...
  messages: {
    ...
    GroupsPerPage: { id: 'GroupsPerPage', value: '{0} Gruppen pro Seite', comment: 'Dropdown allows the user to select how many visible Groups the {} placeholder shows value.' },
    ...
    Large: { id: 'Large', value: 'Groß', comment: 'A larger row sizes with taller rows' },
