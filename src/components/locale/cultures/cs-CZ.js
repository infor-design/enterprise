...
Soho.Locale.addCulture('cs-CZ', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'Vyberte ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'Vyberte ', comment: 'Audible tooltip for choosing an item in a list.' },
