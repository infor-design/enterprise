...
Soho.Locale.addCulture('cs-CZ', {
  ...
  messages: {
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Vybrat vlastní barvu', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Soubory nahrajete přetažením nebo <span class=“hyperlink“>nahráním</span>', comment: 'Updated recently' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Soubory nahrajete přetažením sem', comment: 'New' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Chyba</em> Nelze nahrát větší než maximální počet souborů ({maxFiles})', comment: 'New' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Chyba</em> Překročen limit počtu souborů', comment: 'New' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Chyba</em> Překročen limit velikosti souboru', comment: 'New' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Chyba</em> Nepovolený typ souboru', comment: 'New' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Chyba</em> Adresa URL nenalezena', comment: 'New' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Chyba</em> Záhlaví požadavku musí být platný řetězec JSON', comment: 'New' },
    UploadLink: { id: 'UploadLink', value: 'nahrát soubory', comment: 'New' },
    UploadCancel: { id: 'UploadCancel', value: 'Zrušit odesílání tohoto souboru', comment: 'New' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Zrušit vše', comment: 'New' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Zrušit tuto chybu', comment: 'New' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: 'Soubor {file-name} nahrán, {loaded} z {size} ({percent} %)', comment: 'New - contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Odebrat tento soubor', comment: 'New' },
    UploadStart: { id: 'UploadStart', value: 'Začít s nahráváním tohoto souboru', comment: 'New' },
