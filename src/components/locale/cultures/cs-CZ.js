...
Soho.Locale.addCulture('cs-CZ', {
  ...
  messages: {
    ...
    GroupsPerPage: { id: 'GroupsPerPage', value: 'Skupin na stránku: {0}', comment: 'Dropdown allows the user to select how many visible Groups the {} placeholder shows value.' },
    ...
    Large: { id: 'Large', value: 'Velké', comment: 'A larger row sizes with taller rows' },
