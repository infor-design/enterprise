...
Soho.Locale.addCulture('cs-CZ', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Tlačítko sbalení rozdělovače', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Úchyt pro přetažení rozdělovače', comment: 'Drags the splitter handle' },
