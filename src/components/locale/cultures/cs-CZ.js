...
Soho.Locale.addCulture('cs-CZ', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: 'Počet záznamů na stránku: {0}', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
