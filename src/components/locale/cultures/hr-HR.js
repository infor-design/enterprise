...
Soho.Locale.addCulture('hr-HR', {
  ...
  messages: {
    ...
    GroupsPerPage: { id: 'GroupsPerPage', value: 'Broj grupa po stranici: {0}', comment: 'Dropdown allows the user to select how many visible Groups the {} placeholder shows value.' },
    ...
    Large: { id: 'Large', value: 'Veliki', comment: 'A larger row sizes with taller rows' },
