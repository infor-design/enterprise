...
Soho.Locale.addCulture('hr-HR', {
  ...
  messages: {
    ...
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Pokretač birača vremena', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
