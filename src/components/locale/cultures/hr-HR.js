...
Soho.Locale.addCulture('hr-HR', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'Odaberi ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'Odaberi ', comment: 'Audible tooltip for choosing an item in a list.' },
