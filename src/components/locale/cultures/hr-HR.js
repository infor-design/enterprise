...
Soho.Locale.addCulture('hr-HR', {
  ...
  messages: {
    ...
    AreaChart: { id: 'AreaChart', value: 'Grafikon područja', comment: 'A chart type' },
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Odaberite prilagođenu boju', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
    ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Kliknite za otvaranje birača boja', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
    ...
    DropdownTriggerButton: { id: 'DropdownTriggerButton', value: 'Kliknite za otvaranje padajućeg izbornika', comment: 'Used in accessible labels to describe a dropdown\'s trigger button to assistive technology' },
    ...
    English: { id: 'English', value: 'engleski (Australija)', comment: 'Language name for English' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Povucite i ispustite ili <span class="hyperlink">odaberite datoteke</span> za prijenos' },
