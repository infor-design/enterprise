...
Soho.Locale.addCulture('hr-HR', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} Zapisi po stranici', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
