...
Soho.Locale.addCulture('hr-HR', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Gumb sažimanja razdjelnika', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Hvatište za povlačenje razdjelnika', comment: 'Drags the splitter handle' },
