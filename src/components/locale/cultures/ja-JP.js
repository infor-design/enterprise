...
Soho.Locale.addCulture('ja-JP', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: 'ページあたりのレコード数 {0}', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'スプリッター折りたたみボタン', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'スプリッタードラッグハンドル', comment: 'Drags the splitter handle' },
