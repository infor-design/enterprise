...
Soho.Locale.addCulture('ja-JP', {
  ...
  messages: {
    ...
    AreaChart: { id: 'AreaChart', value: '面グラフ', comment: 'A chart type' },
    ...
    English: { id: 'English', value: '英語 (オーストラリア)', comment: 'Language name for English' },
    ...
    GreaterOrEquals: { id: 'GreaterOrEquals', value: '次の値より大きいか等しい', comment: 'Greater Than Or Equals in icons for filtering' },
    ...
    LessOrEquals: { id: 'LessOrEquals', value: '次の値より小さいか等しい', comment: 'Less Than Or Equals in icons for filtering' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'ドラッグアンドドロップ、または <span class="hyperlink">ファイルを選択</span> してアップロード' },
    ...
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: '時刻の選択トリガー', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
