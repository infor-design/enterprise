...
Soho.Locale.addCulture('no-NO', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} oppføringer per side', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
