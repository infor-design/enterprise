...
Soho.Locale.addCulture('no-NO', {
  ...
  messages: {
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Velg en ønsket farge', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
