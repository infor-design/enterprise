...
Soho.Locale.addCulture('no-NO', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'Velg ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'Velg ', comment: 'Audible tooltip for choosing an item in a list.' },
