...
Soho.Locale.addCulture('no-NO', {
  ...
  messages: {
    ...
    ExtraSmall: { id: 'ExtraSmall', value: 'Ekstra liten', comment: 'A smaller font size and compressed mode for datagrid rows. NOTE: Please change french to Très petite (Masculine form)' },
