...
Soho.Locale.addCulture('no-NO', {
  ...
  messages: {
    ...
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Klikk for å åpne tidsvelger', comment: 'Used in accessible labels to describe a time picker fields trigger button to assistive technology' },
