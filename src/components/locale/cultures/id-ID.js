...
Soho.Locale.addCulture('id-ID', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'Pilih ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'Pilih ', comment: 'Audible tooltip for choosing an item in a list.' },
