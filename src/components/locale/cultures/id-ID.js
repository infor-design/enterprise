...
Soho.Locale.addCulture('id-ID', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Tombol Ciutkan Splitter', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Handel Tarik Splitter', comment: 'Drags the splitter handle' },
