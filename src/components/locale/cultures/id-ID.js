...
Soho.Locale.addCulture('id-ID', {
  ...
  messages: {
    ...
    GroupsPerPage: { id: 'GroupsPerPage', value: '{0} Grup per halaman', comment: 'Dropdown allows the user to select how many visible Groups the {} placeholder shows value.' },
