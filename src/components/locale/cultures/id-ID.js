...
Soho.Locale.addCulture('id-ID', {
  ...
  messages: {
    ...
    Blockquote: { id: 'Blockquote', value: 'Kutipan blok', comment: 'Term for Block Quotations in editing (please check this for thai see https://github.com/infor-design/enterprise/issues/4738)' },
    ...
    ClearFilter: { id: 'ClearFilter', value: 'Bersihkan Filter', comment: 'Clear the current filter criteria - plese check this for greek https://github.com/infor-design/enterprise/issues/4791' },
