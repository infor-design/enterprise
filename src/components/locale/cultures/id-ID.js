...
Soho.Locale.addCulture('id-ID', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} Rekaman per halaman', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
