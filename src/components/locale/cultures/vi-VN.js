...
Soho.Locale.addCulture('vi-VN', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} Bản ghi mỗi trang', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
