...
Soho.Locale.addCulture('vi-VN', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'Chọn một ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'Chọn một ', comment: 'Audible tooltip for choosing an item in a list.' },
