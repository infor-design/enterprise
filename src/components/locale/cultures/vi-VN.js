...
Soho.Locale.addCulture('vi-VN', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Nút Thu gọn bộ chia tách', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Móc kéo bộ chia tách', comment: 'Drags the splitter handle' },
