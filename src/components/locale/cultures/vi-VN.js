...
Soho.Locale.addCulture('vi-VN', {
  ...
  messages: {
    ...
    Blockquote: { id: 'Blockquote', value: 'Thẻ trích dẫn khối', comment: 'Term for Block Quotations in editing (please check this for thai see https://github.com/infor-design/enterprise/issues/4738)' },
    ...
    ClearFilter: { id: 'ClearFilter', value: 'Xóa bộ lọc', comment: 'Clear the current filter criteria - plese check this for greek https://github.com/infor-design/enterprise/issues/4791' },
