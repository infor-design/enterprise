...
Soho.Locale.addCulture('et-EE', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Poolitaja peitmisnupp', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Poolitaja lohistamispide', comment: 'Drags the splitter handle' },
