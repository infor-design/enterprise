...
Soho.Locale.addCulture('et-EE', {
  ...
  messages: {
    ...
    AreaChart: { id: 'AreaChart', value: 'Aladiagramm', comment: 'A chart type' },
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Valige kohandatud värv', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
    ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Klõpsake värvivalija avamiseks', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
    ...
    DatePickerTriggerButton: { id: 'DatePickerTriggerButton', value: 'Kuupäevavalija päästik', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
    ...
    English: { id: 'English', value: 'Inglise (Austraalia)', comment: 'Language name for English' },
    ...
    InvalidDateTime: { id: 'InvalidDateTime', value: 'Kehtetu kuupäev või kellaaeg', comment: 'validation message for wrong date and time format' },
    ...
    LookupTriggerButton: { id: 'LookupTriggerButton', value: 'Otsingu päästik', comment: 'Used in accessible labels to describe a lookup field\'s trigger button to assistive technology' },
    ...
    MonthWideLowerCaseApr: { id: 'MonthWideApr', value: 'Aprill', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    ...
    MonthWideLowerCaseDec: { id: 'MonthWideDec', value: 'Detsember', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    ...
    MonthWideLowerCaseJan: { id: 'MonthWideJan', value: 'Jaanuar', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJuly: { id: 'MonthWideJuly', value: 'Juuli', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJune: { id: 'MonthWideJune', value: 'Juuni', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseMar: { id: 'MonthWideMar', value: 'Märts', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    ...
    MonthWideLowerCaseOct: { id: 'MonthWideOct', value: 'Oktoober', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Üleslaadimiseks pukseeri või <span class="hyperlink">vali failid</span>' },
    ...
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Klõpsake ajavalija avamiseks', comment: 'Used in accessible labels to describe a time picker field\'s trigger button to assistive technology' },
