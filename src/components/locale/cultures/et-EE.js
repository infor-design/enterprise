...
Soho.Locale.addCulture('et-EE', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'Valige ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'Valige ', comment: 'Audible tooltip for choosing an item in a list.' },
