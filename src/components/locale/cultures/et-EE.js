...
Soho.Locale.addCulture('et-EE', {
  ...
  messages: {
    ...
    GroupsPerPage: { id: 'GroupsPerPage', value: '{0} rühma leheküljel', comment: 'Dropdown allows the user to select how many visible Groups the {} placeholder shows value.' },
    ...
    Large: { id: 'Large', value: 'Suur', comment: 'A larger row sizes with taller rows' },
