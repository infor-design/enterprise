...
Soho.Locale.addCulture('et-EE', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} kirjet leheküljel', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
    ...
    ResultsOf: { id: 'ResultsOf', value: '{0} {1}st tulemusest', comment: 'Text Showing current and total number of Results' },
