...
Soho.Locale.addCulture('et-EE', {
  ...
  messages: {
    ...
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Timepickeri päästik', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
