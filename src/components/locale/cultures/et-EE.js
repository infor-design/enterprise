...
Soho.Locale.addCulture('et-EE', {
  ...
  messages: {
    ...
    CharactersMax: { id: 'CharactersMax', value: 'Tähemärkide maksimumarv {0}', comment: 'indicator showing how many max characters you can type.' },
    ...
    EarlyOrUntil: { id: 'EarlyOrUntil', value: 'Varem kui või kuni', comment: 'Earlier than or equals in icons for filtering' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Üleslaadimiseks pukseerige failid siia või <span class="hyperlink">upload files</span> et failid üles laadida', comment: 'Updated recently' },
    ...
    TimepickerPopup: { id: 'TimepickerPopup', value: 'Ajavalija hüpikaken', comment: 'Text read out by assistive technology that explains that the user is interacting with a Timepicker popup.' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Failide üleslaadimiseks pukseerige need siia', comment: 'New' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Tõrge.</em> Ei saa üles laadida rohkem kui maksimaalne lubatud arv faile ({maxFiles})', comment: 'New' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Tõrge.</em> Suurim lubatud failide arv on ületatud', comment: 'New' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Tõrge.</em> Faili mahupiirang on ületatud', comment: 'New' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Tõrge.</em> Faili tüüp pole lubatud', comment: 'New' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Tõrge.</em> URL-i ei leitud', comment: 'New' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Tõrge.</em> Taotluse päis peab olema kehtiv JSON-string', comment: 'New' },
    UploadLink: { id: 'UploadLink', value: 'laadi failid üles', comment: 'New' },
    UploadCancel: { id: 'UploadCancel', value: 'Tühista selle faili üleslaadimine', comment: 'New' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Tühista kõik', comment: 'New' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Sulge see tõrge', comment: 'New' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} – {loaded}/{size} üles laaditud ({percent}%)', comment: 'New - contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Eemalda see fail', comment: 'New' },
    UploadStart: { id: 'UploadStart', value: 'Alusta selle faili üleslaadimist', comment: 'New' },
