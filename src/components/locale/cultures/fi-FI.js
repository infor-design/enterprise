...
Soho.Locale.addCulture('fi-FI', {
  ...
  messages: {
    ...
    Locale: { id: 'Locale', value: 'Maa', comment: 'The users locale string for example en-US, it-It' },
    ...
    Results: { id: 'Results', value: 'Tulokset', comment: 'As in showing N Results (plural) in a List' },
