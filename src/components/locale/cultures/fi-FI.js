...
Soho.Locale.addCulture('fi-FI', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'Valitse ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'Valitse ', comment: 'Audible tooltip for choosing an item in a list.' },
