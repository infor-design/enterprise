...
Soho.Locale.addCulture('hu-HU', {
  ...
  messages: {
    ...
    ResultOf: { id: 'ResultOf', value: '{0} eredmény a(z) {1} -ből', comment: 'Text Showing current and total number of Result' },
    ResultsOf: { id: 'ResultsOf', value: '{0} eredmény a(z) {1} -ből', comment: 'Text Showing current and total number of Results' },
