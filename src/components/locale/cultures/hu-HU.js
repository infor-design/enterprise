...
Soho.Locale.addCulture('hu-HU', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} rekord oldalanként', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
