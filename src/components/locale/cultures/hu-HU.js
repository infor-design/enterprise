...
Soho.Locale.addCulture('hu-HU', {
  ...
  messages: {
    ...
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Időválasztó kiváltója', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
