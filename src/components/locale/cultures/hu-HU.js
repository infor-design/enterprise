...
Soho.Locale.addCulture('hu-HU', {
  ...
  messages: {
    ...
    EarlyOrUntil: { id: 'EarlyOrUntil', value: 'Korábbi, mint vagy eddig', comment: 'Earlier than or equals in icons for filtering' },
    ...
    MonthWideLowerCaseMay: { id: 'MonthWideMay', value: 'május', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'A feltöltéshez húzza ide a fájlokat, vagy használja a <span class="hyperlink">fájlok feltöltése</span> lehetőséget', comment: 'Updated recently' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Húzza ide a fájlokat a feltöltéshez', comment: 'New' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Hiba</em> Nem tölthető fel a maximálisan megengedettnél több fájl ({maxFiles})', comment: 'New' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Hiba</em> Túllépte a fájlok megengedett maximális számát', comment: 'New' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Hiba</em> Túllépte a maximális fájlméretet', comment: 'New' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Hiba</em> A fájltípus használata nem megengedett', comment: 'New' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Hiba</em> Nincsenek találatok', comment: 'New' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Hiba</em> A Kérelemfejlécek elemnek érvényes JSON-sztringnek kell lennie', comment: 'New' },
    UploadLink: { id: 'UploadLink', value: 'fájlok feltöltése', comment: 'New' },
    UploadCancel: { id: 'UploadCancel', value: 'Fájl feltöltésének megszakítása', comment: 'New' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Összes megszakítása', comment: 'New' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Hibaüzenet bezárása', comment: 'New' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} feltöltve {loaded}/{size} ({percent}%)', comment: 'New - contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Fájl eltávolítása', comment: 'New' },
    UploadStart: { id: 'UploadStart', value: 'Fájl feltöltésének megkezdése', comment: 'New' },
