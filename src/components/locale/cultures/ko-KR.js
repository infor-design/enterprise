...
Soho.Locale.addCulture('ko-KR', {
  ...
  messages: {
    ...
    Blockquote: { id: 'Blockquote', value: '인용 문단', comment: 'Term for Block Quotations in editing (please check this for thai see https://github.com/infor-design/enterprise/issues/4738)' },
    ...
    ClearFilter: { id: 'ClearFilter', value: '필터 지우기', comment: 'Clear the current filter criteria - plese check this for greek https://github.com/infor-design/enterprise/issues/4791' },
