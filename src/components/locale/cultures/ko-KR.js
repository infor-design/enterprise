...
Soho.Locale.addCulture('ko-KR', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: '선택 ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: '선택 ', comment: 'Audible tooltip for choosing an item in a list.' },
