...
Soho.Locale.addCulture('ko-KR', {
  ...
  messages: {
    ...
    AreaChart: { id: 'AreaChart', value: '영역 차트', comment: 'A chart type' },
    ...
    English: { id: 'English', value: '영어(호주)', comment: 'Language name for English' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: '업로드할 <span class="hyperlink">파일을 선택</span>하거나 끌어다 놓으십시오.' },
