...
Soho.Locale.addCulture('ko-KR', {
  ...
  messages: {
    ...
    GroupsPerPage: { id: 'GroupsPerPage', value: '페이지당 {0}개의 그룹', comment: 'Dropdown allows the user to select how many visible Groups the {} placeholder shows value.' },
    ...
    Large: { id: 'Large', value: '대형', comment: 'A larger row sizes with taller rows' },
