...
Soho.Locale.addCulture('ko-KR', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: '축소 분할기', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: '끌어서 조정', comment: 'Drags the splitter handle' },
