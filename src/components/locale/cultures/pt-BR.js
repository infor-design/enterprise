...
Soho.Locale.addCulture('pt-BR', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Botão para recolher divisor', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Alça para arrastar divisor', comment: 'Drags the splitter handle' },
