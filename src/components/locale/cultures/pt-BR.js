...
Soho.Locale.addCulture('pt-BR', {
  ...
  messages: {
    ...
    Blockquote: { id: 'Blockquote', value: 'Citação em bloco', comment: 'Term for Block Quotations in editing (please check this for thai see https://github.com/infor-design/enterprise/issues/4738)' },
