...
Soho.Locale.addCulture('zh-Hans', {
  ...
  messages: {
    ...
    DatePickerTriggerButton: { id: 'DatePickerTriggerButton', value: '日期选择器触发', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
    ...
    InsertHyperlink: { id: 'InsertHyperlink', value: '插入超链接', comment: 'Insert a hyperlink in an editor' },
    ...
    LookupTriggerButton: { id: 'LookupTriggerButton', value: '查找触发器', comment: 'Used in accessible labels to describe a lookup field\'s trigger button to assistive technology' },
    ...
    ShowEvent: { id: 'ShowEvent', value: '显示事件的', comment: 'Show an event (in a calendar)' },
    ...
    StrikeThrough: { id: 'StrikeThrough', value: '穿透', comment: 'Edit text to have a strike through it in an editor' },
    ...
    TimepickerPopup: { id: 'TimepickerPopup', value: '时间选取器', comment: 'text read out by assistive technology that explains that the user is interacting with a Timepicker popup.' },
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: '时间选择器触发', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
    ...
    ViewVisual: { id: 'ViewVisual', value: '视图对象', comment: 'Toggle between the source view and visual view' },
