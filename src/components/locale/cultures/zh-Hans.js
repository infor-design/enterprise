...
Soho.Locale.addCulture('zh-Hans', {
  ...
  messages: {
    ...
    Blockquote: { id: 'Blockquote', value: '块引用', comment: 'insert a block quote in the editor' },
    ...
    InsertAnchor: { id: 'InsertAnchor', value: '插入锚', comment: 'Insert Acnhor (link) in an editor' },
    ...
    StrikeThrough: { id: 'StrikeThrough', value: '罢工', comment: 'turn on and off strike through text in text editor (like word)' },
