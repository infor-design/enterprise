...
Soho.Locale.addCulture('zh-Hans', {
  ...
  messages: {
    ...
    ChangeSelection: { id: 'ChangeSelection', value: '. 要更改选择，使用箭头键。', comment: 'Audible Text for drop down list help' },
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: '拆分器折叠按钮', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: '拆分器拖动手柄', comment: 'Drags the splitter handle' },
