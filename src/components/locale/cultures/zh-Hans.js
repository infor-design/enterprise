...
Soho.Locale.addCulture('zh-Hans', {
  ...
  messages: {
    ...
    Next: { id: 'Next', value: '下一页', comment: 'Next in icons tooltip' },
    ...
    Previous: { id: 'Previous', value: '上一页', comment: 'Previous icon tooltip - moved to previous record' },
    ...
    ResultOf: { id: 'ResultOf', value: '{0}/{1} 个结果', comment: 'Text Showing current and total number of Result' },
    ResultsOf: { id: 'ResultsOf', value: '{0}/{1} 个结果', comment: 'Text Showing current and total number of Results' },
