...
Soho.Locale.addCulture('zh-Hans', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: '选择一个 ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: '选择一个 ', comment: 'Audible tooltip for choosing an item in a list.' },
