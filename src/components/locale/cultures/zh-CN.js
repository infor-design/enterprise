...
Soho.Locale.addCulture('zh-CN', {
  ...
  messages: {
    ...
    English: { id: 'English', value: '英语(澳大利亚)', comment: 'Language name for English' },
    ...
    Previous: { id: 'Previous', value: '上一个', comment: 'Previous icon tooltip - moved to previous record' },
    ...
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: '触发时间选择器', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
