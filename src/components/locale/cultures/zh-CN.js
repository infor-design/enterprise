...
Soho.Locale.addCulture('zh-CN', {
  ...
  messages: {
    ...
    Blockquote: { id: 'Blockquote', value: '块引用', comment: 'Term for Block Quotations in editing (please check this for thai see https://github.com/infor-design/enterprise/issues/4738)' },
    ...
    ClearFilter: { id: 'ClearFilter', value: '清除筛选器', comment: 'Clear the current filter criteria - plese check this for greek https://github.com/infor-design/enterprise/issues/4791' },
