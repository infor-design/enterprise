...
Soho.Locale.addCulture('fr-CA', {
  ...
  messages: {
    ...
    AdditionalItems: { id: 'AdditionalItems', value: 'Éléments supplémentaires', comment: 'Button tooltip used in a list of movable items' },
    ...
    Locale: { id: 'Locale', value: 'Paramètre régional', comment: 'A place or locality for example en-US, it-It ect' },
