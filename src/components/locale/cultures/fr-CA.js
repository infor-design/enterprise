...
Soho.Locale.addCulture('fr-CA', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Bouton de réduction du séparateur', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Poignée de glissement du séparateur', comment: 'Drags the splitter handle' },
