...
Soho.Locale.addCulture('hi-IN', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} रिकॉर्ड प्रति पृष्ठ', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
