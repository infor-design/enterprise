...
Soho.Locale.addCulture('hi-IN', {
  ...
  messages: {
    ...
    GroupsPerPage: { id: 'GroupsPerPage', value: '{0} समूह प्रति पृष्ठ', comment: 'Dropdown allows the user to select how many visible Groups the {} placeholder shows value.' },
    ...
    Large: { id: 'Large', value: 'बड़ा', comment: 'A larger row sizes with taller rows' },
    ...
    Small: { id: 'Small', value: 'छोटा', comment: 'A more small grid setting for rows and sizes' },
