...
Soho.Locale.addCulture('hi-IN', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'स्प्लिटर संक्षिप्त बटन', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'स्प्लिटर ड्रैग हैंडल', comment: 'Drags the splitter handle' },
