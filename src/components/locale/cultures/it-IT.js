...
Soho.Locale.addCulture('it-IT', {
  ...
  messages: {
    ...
    AreaChart: { id: 'AreaChart', value: 'Grafico ad area', comment: 'A chart type' },
    ...
    Small: { id: 'Small', value: 'Piccola', comment: 'A more small grid setting for rows and sizes. NOTE: Please change french to Petite (Masculine form)' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Selezionare e trascinare o usare <span class="hyperlink">Seleziona file</span> per caricare i file' },
