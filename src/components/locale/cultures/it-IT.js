...
Soho.Locale.addCulture('it-IT', {
  ...
  messages: {
    ...
    ExtraSmall: { id: 'ExtraSmall', value: 'Molto piccolo', comment: 'A smaller font size and compressed mode for datagrid rows' },
    ...
    GroupsPerPage: { id: 'GroupsPerPage', value: '{0} gruppi per pagina', comment: 'Dropdown allows the user to select how many visible Groups the {} placeholder shows value.' },
    ...
    Small: { id: 'Small', value: 'Piccolo', comment: 'A more small grid setting for rows and sizes' },
