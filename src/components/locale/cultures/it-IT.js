...
Soho.Locale.addCulture('it-IT', {
  ...
  messages: {
    ...
    CharactersMax: { id: 'CharactersMax', value: 'Numero max caratteri di {0}', comment: 'indicator showing how many max characters you can type.' },
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Scegliere un colore personalizzato', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
    ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Fare clic per aprire Selezione colori', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
    ...
    DatePickerTriggerButton: { id: 'DatePickerTriggerButton', value: 'Trigger selezione data', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
    ...
    EarlyOrUntil: { id: 'EarlyOrUntil', value: 'Prima di o fino a', comment: 'Earlier than or equals in icons for filtering' },
    ...
    LookupTriggerButton: { id: 'LookupTriggerButton', value: 'Trigger ricerca', comment: 'Used in accessible labels to describe a lookup field\'s trigger button to assistive technology' },
    ...
    MonthWideLowerCaseApr: { id: 'MonthWideApr', value: 'aprile', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    ...
    MonthWideLowerCaseDec: { id: 'MonthWideDec', value: 'dicembre', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    ...
    MonthWideLowerCaseJan: { id: 'MonthWideJan', value: 'gennaio', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJuly: { id: 'MonthWideJuly', value: 'luglio', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJune: { id: 'MonthWideJune', value: 'giugno', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    ...
    MonthWideLowerCaseMay: { id: 'MonthWideMay', value: 'maggio', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    ...
    MonthWideLowerCaseOct: { id: 'MonthWideOct', value: 'ottobre', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseSep: { id: 'MonthWideSep', value: 'settembre', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Selezionare e trascinare qui o <span class="hyperlink">caricare i file</span> da caricare', comment: 'Updated recently' },
    ...
    TimepickerPopup: { id: 'TimepickerPopup', value: 'Finestra a comparsa selezione ora', comment: 'Text read out by assistive technology that explains that the user is interacting with a Timepicker popup.' },
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Fare clic qui per aprire Selezione ora', comment: 'Used in accessible labels to describe a time picker field\'s trigger button to assistive technology' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Selezionare e trascinare qui per caricare i file', comment: 'New' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Errore</em> Non è possibile aggiornare un numero di file superiore al massimo consentito ({maxFiles}).', comment: 'New' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Errore</em> È stato superato il numero massimo di file consentiti', comment: 'New' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Errore</em> È stata superata la dimensione massima file', comment: 'New' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Errore</em> Tipo di file non consentito', comment: 'New' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Errore</em> Url non trovato', comment: 'New' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Errore</em> Le intestazioni della richiesta devono essere una stringa JSON valida', comment: 'New' },
    UploadLink: { id: 'UploadLink', value: 'caricare i file', comment: 'New' },
    UploadCancel: { id: 'UploadCancel', value: 'Annulla caricamento file corrente', comment: 'New' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Annulla tutto', comment: 'New' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Elimina questo errore', comment: 'New' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} caricati {loaded} su {size} ({percent}%)', comment: 'New - contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Rimuovi questo file', comment: 'New' },
    UploadStart: { id: 'UploadStart', value: 'Inizia caricamento file corrente', comment: 'New' },
