...
Soho.Locale.addCulture('it-IT', {
  ...
  messages: {
    ...
    English: { id: 'English', value: 'Inglese (Australia)', comment: 'Language name for English' },
    ...
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Trigger selezione ora', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
