...
Soho.Locale.addCulture('sl-SI', {
  ...
  messages: {
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Izbira barve po meri', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
    ...
    EarlyOrUntil: { id: 'EarlyOrUntil', value: 'Prej kot ali do', comment: 'Earlier than or equals in icons for filtering' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Datoteke, ki jih želite naložiti, povlecite in spustite sem ali <span class="hyperlink">naložite</span>', comment: 'Updated recently' },
    ...
    TimepickerPopup: { id: 'TimepickerPopup', value: 'Pojavno okno izbirnika ure', comment: 'Text read out by assistive technology that explains that the user is interacting with a Timepicker popup.' },
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Kliknite, da odprete izbirnik ure', comment: 'Used in accessible labels to describe a time picker field\'s trigger button to assistive technology' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Povlecite in spustite sem, da naložite datoteke', comment: 'New' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Napaka</em> Naložiti je mogoče največ toliko datotek: {maxFiles}', comment: 'New' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Napaka</em> Omejitev največjega števila datotek je presežena', comment: 'New' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Napaka</em> Omejitev velikosti datoteke je presežena', comment: 'New' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Napaka</em> Vrsta datoteke ni dovoljena', comment: 'New' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Napaka</em> URL-ja ni mogoče najti', comment: 'New' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Napaka</em> Glave zahteve morajo biti veljaven niz JSON', comment: 'New' },
    UploadLink: { id: 'UploadLink', value: 'nalaganje datotek', comment: 'New' },
    UploadCancel: { id: 'UploadCancel', value: 'Prekliči prenašanje te datoteke', comment: 'New' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Prekliči vse', comment: 'New' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Opusti to napako', comment: 'New' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} – naložena: {loaded} od {size} ({percent} %)', comment: 'New - contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Odstrani to datoteko', comment: 'New' },
    UploadStart: { id: 'UploadStart', value: 'Začni nalaganje te datoteke', comment: 'New' },
