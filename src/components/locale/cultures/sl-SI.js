...
Soho.Locale.addCulture('sl-SI', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'Izberite ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'Izberite ', comment: 'Audible tooltip for choosing an item in a list.' },
