...
Soho.Locale.addCulture('sl-SI', {
  ...
  messages: {
    ...
    InsertHyperlink: { id: 'InsertHyperlink', value: 'Vstavi hiperpovezavo', comment: 'Insert a hyperlink in an editor' },
