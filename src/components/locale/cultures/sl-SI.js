...
Soho.Locale.addCulture('sl-SI', {
  ...
  messages: {
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Izberite barvo po meri', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
    ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Kliknite, da odprete izbirnik barv', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
    ...
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Kliknite, da odprete izbirnik časa', comment: 'Used in accessible labels to describe a time picker field\'s trigger button to assistive technology' },
