...
Soho.Locale.addCulture('sl-SI', {
  ...
  messages: {
    ...
    GroupsPerPage: { id: 'GroupsPerPage', value: '{0} Skupin na stran', comment: 'Dropdown allows the user to select how many visible Groups the {} placeholder shows value.' },
    ...
    Large: { id: 'Large', value: 'Veliko', comment: 'A larger row sizes with taller rows' },
