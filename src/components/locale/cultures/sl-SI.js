...
Soho.Locale.addCulture('sl-SI', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Gumb za strnitev razdeljevalnika', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Ročica za vlečenje razdeljevalnika', comment: 'Drags the splitter handle' },
