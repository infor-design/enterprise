...
Soho.Locale.addCulture('sl-SI', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} Zapisov na stran', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
