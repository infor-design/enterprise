...
Soho.Locale.addCulture('fr-FR', {
  ...
  messages: {
    ...
    CharactersMax: { id: 'CharactersMax', value: 'Le nombre de caractères maximum est de {0}', comment: 'indicator showing how many max characters you can type.' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Glisser-déposer ici ou <span class="hyperlink">Charger les fichiers</span> pour les charger', comment: 'Updated recently' },
    ...
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Erreur</em> Impossible de charger plus que le nombre maximum de fichiers ({maxFiles}).', comment: 'New' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Erreur</em> Dépassement du nombre maximum de fichiers autorisés', comment: 'New' },
    ...
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Erreur</em> Url non trouvée', comment: 'New' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Erreur</em> En-têtes de demande doivent être une chaîne JSON valide', comment: 'New' },
    ...
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} a chargé {loaded} sur {size} ({percent}%)', comment: 'New - contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Supprimer ce fichier', comment: 'New' },
    UploadStart: { id: 'UploadStart', value: 'Démarrer le chargement de ce fichier', comment: 'New' },
