...
Soho.Locale.addCulture('uk-UA', {
  ...
  messages: {
    ...
    Large: { id: 'Large', value: 'Велика', comment: 'A larger row sizes with taller rows' },
    ...
    Locale: { id: 'Locale', value: 'Локалізація', comment: 'A place or locality for example en-US, it-It ect' },
    ...
    Small: { id: 'Small', value: 'Дрібна', comment: 'A more small grid setting for rows and sizes' },
