...
Soho.Locale.addCulture('uk-UA', {
  ...
  messages: {
    ...
    Large: { id: 'Large', value: 'Великий', comment: 'A larger row sizes with taller rows' },
    ...
    Small: { id: 'Small', value: 'Дрібний', comment: 'A more small grid setting for rows and sizes' },
