...
Soho.Locale.addCulture('uk-UA', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Кнопка згортання роздільника', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Маркер перетягування роздільника', comment: 'Drags the splitter handle' },
