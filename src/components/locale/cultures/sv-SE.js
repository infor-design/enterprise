...
Soho.Locale.addCulture('sv-SE', {
  ...
  messages: {
    ...
    AppMenuTriggerTextAlt: { id: 'AppMenuTriggerTextAlt', value: 'Trigger för programmeny', comment: 'Default text used inside of Application Menu trigger buttons' },
    ...
    InsertHyperlink: { id: 'InsertHyperlink', value: 'Infoga hyperlänk', comment: 'Insert a hyperlink in an editor' },
