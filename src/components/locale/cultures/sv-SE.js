...
Soho.Locale.addCulture('sv-SE', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'Välj ett alternativ ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'Välj ett alternativ ', comment: 'Audible tooltip for choosing an item in a list.' },
