...
Soho.Locale.addCulture('sv-SE', {
  ...
  messages: {
    ...
    English: { id: 'English', value: 'Engelska (Australien)', comment: 'Language name for English' },
    ...
    TimepickerPopup: { id: 'TimepickerPopup', value: 'Popup-fönster för val av tid', comment: 'text read out by assistive technology that explains that the user is interacting with a Timepicker popup.' },
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Trigger för tidsväljare', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
