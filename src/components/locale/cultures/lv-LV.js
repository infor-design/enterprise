...
Soho.Locale.addCulture('lv-LV', {
  ...
  messages: {
    ...
    AreaChart: { id: 'AreaChart', value: 'Laukumu diagramma', comment: 'A chart type' },
    ...
    ChooseFont: { id: 'ChooseFont', value: 'Izvēlieties fonta stilu', comment: 'Choose a font style' },
    ...
    English: { id: 'English', value: 'Angļu (Austrālija)', comment: 'Language name for English' },
    ...
    NextWeek: { id: 'NextWeek', value: 'Nākamnedēļ', comment: 'the label for the button that moves calendar to next/prev' },
    ...
    PreviousWeek: { id: 'PreviousWeek', value: 'Pagājušonedēļ', comment: 'the label for the button that moves calendar to next/prev' },
    ...
    SelectAll: { id: 'SelectAll', value: 'Atlasīt visus', comment: 'describes the action of selecting all items available in a list' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Velciet un nometiet vai <span class="hyperlink">atlasiet failus</span>, lai augšupielādētu' },
    ...
    ToggleBold: { id: 'ToggleBold', value: 'Pārslēgt tekstu treknrakstā', comment: 'turn on and off bold in text editor (like word) please check this for thai see https://github.com/infor-design/enterprise/issues/4738' },
    ...
    ToggleUnderline: { id: 'ToggleUnderline', value: 'Pārslēgt tekstu pasvītrojumā', comment: 'turn on and off Underline in text editor (like word) please check this for thai https://github.com/infor-design/enterprise/issues/4738' },
