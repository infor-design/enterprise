...
Soho.Locale.addCulture('lv-LV', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Sadalītāja sakļaušanas poga', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Vilkt sadalītāja turi', comment: 'Drags the splitter handle' },
