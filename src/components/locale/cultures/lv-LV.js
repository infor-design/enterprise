...
Soho.Locale.addCulture('lv-LV', {
  ...
  messages: {
    ...
    GroupsPerPage: { id: 'GroupsPerPage', value: '{0}‎ Grupas vienā lapā', comment: 'Dropdown allows the user to select how many visible Groups the {} placeholder shows value. NOTE: Please change japanese to ページあたりのグループ数 for next time' },
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0}‎ ieraksti vienā lapā', comment: 'Shows an actual number of pages in the pager' },
