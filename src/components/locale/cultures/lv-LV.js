...
Soho.Locale.addCulture('lv-LV', {
  ...
  messages: {
    ...
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Laika izvēles aktivizētājs', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
