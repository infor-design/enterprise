...
Soho.Locale.addCulture('nl-NL', {
  ...
  messages: {
    ...
    DaysOverdue: { id: 'DaysOverdue', value: '{0} vervallen dagen', comment: 'For a task /date UI' },
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Splitter invouwen', comment: 'Action to move the position of splitter either to left or right' },
