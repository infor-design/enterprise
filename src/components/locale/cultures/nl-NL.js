...
Soho.Locale.addCulture('nl-NL', {
  ...
  messages: {
    ...
    GroupsPerPage: { id: 'GroupsPerPage', value: '{0} records per pagina', comment: 'Dropdown allows the user to select how many visible Groups the {} placeholder shows value.' },
