...
Soho.Locale.addCulture('nl-NL', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'Kies een ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'Kies een ', comment: 'Audible tooltip for choosing an item in a list.' },
