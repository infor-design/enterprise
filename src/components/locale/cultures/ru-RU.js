...
Soho.Locale.addCulture('ru-RU', {
  ...
  messages: {
    ...
    AdditionalItems: { id: 'AdditionalItems', value: 'Дополнительные элементы', comment: 'Button tooltip used in a list of movable items' },
    ...
    Amber: { id: 'Amber', value: 'Янтарный', comment: 'Color in our color palette' },
    Amethyst: { id: 'Amethyst', value: 'Аметистовый', comment: 'Color in our color palette' },
    ...
    Large: { id: 'Large', value: 'Большой', comment: 'A larger row sizes with taller rows' },
    ...
    Locale: { id: 'Locale', value: 'Локаль', comment: 'A place or locality for example en-US, it-It ect' },
    ...
    Ruby: { id: 'Ruby', value: 'Рубиновый', comment: 'Color in our color palette' },
    ...
    Small: { id: 'Small', value: 'Маленький', comment: 'A more small grid setting for rows and sizes' },
    ...
    Slate: { id: 'Slate', value: 'Аспидный', comment: 'Color in our color palette' },
