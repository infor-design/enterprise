...
Soho.Locale.addCulture('ru-RU', {
  ...
  messages: {
    ...
    ExtraSmall: { id: 'ExtraSmall', value: 'Очень мелкая', comment: 'A smaller font size and compressed mode for datagrid rows. NOTE: Please change french to Très petite (Masculine form)' },
