...
Soho.Locale.addCulture('ru-RU', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Кнопка сворачивания разделителя', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Маркер перетаскивания разделителя', comment: 'Drags the splitter handle' },
