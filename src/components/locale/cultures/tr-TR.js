...
Soho.Locale.addCulture('tr-TR', {
  ...
  messages: {
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Yüklemek için buraya sürükleyip bırakın veya <span class="hyperlink">dosya yükleme</span>', comment: 'Updated recently' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Dosyaları yüklemek için buraya sürükleyip bırakın', comment: 'New' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Hata</em> Maksimum dosya sayısından ({maxFiles}) fazla dosya yüklenemez', comment: 'New' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Hata</em> Maksimum izin verilen dosya aşıldı', comment: 'New' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Hata</em> Dosya boyut sınırı aşıldı', comment: 'New' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Hata</em> Dosya türüne izin verilmiyor', comment: 'New' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Hata</em> Url bulunamadı', comment: 'New' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Hata</em> İstek Başlıkları geçerli bir JSON dizesi olmalıdır', comment: 'New' },
    UploadLink: { id: 'UploadLink', value: 'dosyaları yükle', comment: 'New' },
    UploadCancel: { id: 'UploadCancel', value: 'Bu dosya yüklemesini iptal et', comment: 'New' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Tümünü iptal et', comment: 'New' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Bu hatayı kapat', comment: 'New' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name}, {loaded} / {size} yükledi (%{percent})', comment: 'New - contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Bu dosyayı kaldır', comment: 'New' },
    UploadStart: { id: 'UploadStart', value: 'Bu dosyayı yüklemeye başla', comment: 'New' },
