...
Soho.Locale.addCulture('tr-TR', {
  ...
  messages: {
    ...
    GroupsPerPage: { id: 'GroupsPerPage', value: 'Sayfa başına {0} grup', comment: 'Dropdown allows the user to select how many visible Groups the {} placeholder shows value.' },
    ...
    Large: { id: 'Large', value: 'Büyük', comment: 'A larger row sizes with taller rows' },
    ...
    Results: { id: 'Results', value: 'sonuç', comment: 'As in showing N Results (plural) in a List' },
