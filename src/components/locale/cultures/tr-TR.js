...
Soho.Locale.addCulture('tr-TR', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'Seçim yapın: ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'Seçim yapın: ', comment: 'Audible tooltip for choosing an item in a list.' },
