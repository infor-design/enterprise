...
Soho.Locale.addCulture('tr-TR', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: 'Sayfa başına {0} kayıt', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Ayırıcı Daraltma Düğmesi', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Ayırıcı Sürükleme Tutamacı', comment: 'Drags the splitter handle' },
