...
Soho.Locale.addCulture('ms-bn', {
  ...
  messages: {
    ...
    ExtraSmall: { id: 'ExtraSmall', value: 'Lebih Kecil', comment: 'A smaller font size and compressed mode for datagrid rows. NOTE: Please change french to Très petite (Masculine form)' },
