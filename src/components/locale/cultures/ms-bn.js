...
Soho.Locale.addCulture('ms-bn', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} Rekod setiap halaman', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Butang Runtuhkan Pemisah', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Pemegang Seret Pemisah', comment: 'Drags the splitter handle' },
