...
Soho.Locale.addCulture('ms-bn', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'Pilih satu ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'Pilih satu ', comment: 'Audible tooltip for choosing an item in a list.' },
