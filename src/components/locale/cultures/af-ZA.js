...
Soho.Locale.addCulture('af-ZA', {
  ...
  messages: {
    ...
    Contrast: { id: 'Contrast', value: 'Teenstelling', comment: 'Name of the high contrast theme' },
    ...
    Personalization: { id: 'Personalization', value: 'Persona', comment: 'Refers to changing a personalization in the application like a color.' },
