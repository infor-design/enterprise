...
Soho.Locale.addCulture('af-ZA', {
  ...
  messages: {
    ...
    ChangeSelection: { id: 'ChangeSelection', value: '. Om die keuse te verander, gebruik die pyltjiesleutels.', comment: 'Audible Text for drop down list help' },
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Splitter-invouknoppie', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Splitter-sleephandvatsel', comment: 'Drags the splitter handle' },
