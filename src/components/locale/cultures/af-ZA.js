...
Soho.Locale.addCulture('af-ZA', {
  ...
  messages: {
    ...
    AdditionalItems: { id: 'AdditionalItems', value: 'Bykomende items', comment: 'Button tooltip used in a list of movable items' },
    ...
    Locale: { id: 'Locale', value: 'Lokaliteit', comment: 'A place or locality for example en-US, it-It ect' },
