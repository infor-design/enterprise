...
Soho.Locale.addCulture('af-ZA', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'Kies \'n ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'Kies \'n ', comment: 'Audible tooltip for choosing an item in a list.' },
