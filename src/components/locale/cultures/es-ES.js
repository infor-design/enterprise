...
Soho.Locale.addCulture('es-ES', {
  ...
  messages: {
    ...
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Activador del selector de hora', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
