...
Soho.Locale.addCulture('es-ES', {
  ...
  messages: {
    ...
    ClassicDarkTheme: { id: 'ClassicDarkTheme', value: 'Oscuro clásico', comment: 'The name of an application Theme' },
    ClassicLightTheme: { id: 'ClassicLightTheme', value: 'Luz clásica', comment: 'The name of an application Theme' },
    ClassicHighContrastTheme: { id: 'ClassicHighContrastTheme', value: 'Alto contraste clásico', comment: 'The name of an application Theme' },
    ...
    NewDarkTheme: { id: 'NewDarkTheme', value: 'Nueva oscuridad', comment: 'The name of an application Theme' },
    NewHighContrastTheme: { id: 'NewHighContrastTheme', value: 'Nuevo alto contraste', comment: 'The name of an application Theme' },
    NewLightTheme: { id: 'NewLightTheme', value: 'Nueva luz', comment: 'The name of an application Theme' },
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} registros por página', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Contraer el separador', comment: 'Action to move the position of splitter either to left or right' },
