...
Soho.Locale.addCulture('es-ES', {
  ...
  messages: {
    ...
    ExtraSmall: { id: 'ExtraSmall', value: 'Mas pequeña', comment: 'A smaller font size and compressed mode for datagrid rows' },
    ...
    ResultOf: { id: 'ResultOf', value: '{0} de {1} resultados', comment: 'Text Showing current and total number of Result' },
