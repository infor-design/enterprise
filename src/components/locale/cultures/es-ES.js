...
Soho.Locale.addCulture('es-ES', {
  ...
  messages: {
    ...
    AdministrativeLeave: { id: 'AdministrativeLeave', value: 'Licencia administrativa', comment: 'As in vacation time from work' },
    ...
    CompanyHoliday: { id: 'CompanyHoliday', value: 'Vacaciones de la compañía', comment: 'A holiday provided by work.' },
    ...
    RequestTimeOff: { id: 'RequestTimeOff', value: 'Solicitar tiempo libre', comment: 'Making a request for time off work.' },
    ...
    SameWindow: { id: 'SameWindow', value: 'La misma ventana', comment: 'Contents open in the same browser window.' },
    ...
    Schedule: { id: 'Schedule', value: 'Programar', comment: 'Shows a schedule view' },
    ...
    TeamEvent: { id: 'TeamEvent', value: 'Evento del equipo', comment: 'Having an event with a work team' },
