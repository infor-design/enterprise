...
Soho.Locale.addCulture('es-ES', {
  ...
  messages: {
    ...
    ExtraSmall: { id: 'ExtraSmall', value: 'Extra pequeño', comment: 'A smaller font size and compressed mode for datagrid rows. NOTE: Please change french to Très petite (Masculine form)' },
