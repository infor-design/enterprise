...
Soho.Locale.addCulture('es-ES', {
  ...
  messages: {
    ...
    All: { id: 'All', value: 'Todo', comment: 'All items in the cLoadingontext of a filter' },
    ...
    TimepickerPopup: { id: 'TimepickerPopup', value: 'Emergente de Selector de hora', comment: 'Text read out by assistive technology that explains that the user is interacting with a Timepicker popup.' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Arrastre y coloque aquí para cargar achivos', comment: 'New' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Error</em>: No se puede cargar más de un número máximo de archivos ({maxFiles})', comment: 'New' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Error</em>: Se ha excedido el máximo de archivos permitidos', comment: 'New' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Error</em>: Se ha excedido el límite de tamaño de archivo', comment: 'New' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Error</em>: El tipo de archivo no está permitido', comment: 'New' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Error</em>: No se encontró URL', comment: 'New' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Error</em>: Los encabezados de la solicitud deben tener una cadena JSON válida', comment: 'New' },
    UploadLink: { id: 'UploadLink', value: 'cargar archivos', comment: 'New' },
    UploadCancel: { id: 'UploadCancel', value: 'Cancelar la carga de este archivo', comment: 'New' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Cancelar todo', comment: 'New' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Descargar este error', comment: 'New' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: 'Archivo {file-name} cargado, {loaded} de {size} ({percent}%)', comment: 'New - contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Quitar este archivo', comment: 'New' },
    UploadStart: { id: 'UploadStart', value: 'Iniciar la carga de este archivo', comment: 'New' },
