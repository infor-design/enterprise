...
Soho.Locale.addCulture('es-ES', {
  ...
  messages: {
    ...
    Hide: { id: 'Hide', value: 'Esconder', comment: 'On a Button for revealing text that is hidden' },
    ...
    NextYear: { id: 'NextYear', value: 'El próximo año', comment: 'the label for the button that moves calendar to next/prev' },
