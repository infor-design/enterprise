...
Soho.Locale.addCulture('bg-BG', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} Записи на страница', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
