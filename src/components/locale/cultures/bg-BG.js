...
Soho.Locale.addCulture('bg-BG', {
  ...
  messages: {
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Изберете персонализиран цвят', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
    ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Щракнете, за да отворите инструмента за избор на цвят', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
    ...
    NextWeek: { id: 'NextWeek', value: 'Следващата седмица', comment: 'the label for the button that moves calendar to next/prev' },
    ...
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Щракнете, за да отворите инструмента за избор на време', comment: 'Used in accessible labels to describe a time picker field\'s trigger button to assistive technology' },
