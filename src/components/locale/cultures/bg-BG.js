...
Soho.Locale.addCulture('bg-BG', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'Избиране на ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'Избиране на ', comment: 'Audible tooltip for choosing an item in a list.' },
