...
Soho.Locale.addCulture('bg-BG', {
  ...
  messages: {
    ...
    GroupsPerPage: { id: 'GroupsPerPage', value: '{0} групи на страница', comment: 'Dropdown allows the user to select how many visible Groups the {} placeholder shows value.' },
    ...
    Large: { id: 'Large', value: 'Големи', comment: 'A larger row sizes with taller rows' },
