...
Soho.Locale.addCulture('ro-RO', {
  ...
  messages: {
    ...
    ClearFilter: { id: 'ClearFilter', value: 'Golire filtru', comment: 'Clear the current filter criteria - plese check this for greek https://github.com/infor-design/enterprise/issues/4791' },
