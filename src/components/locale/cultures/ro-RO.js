...
Soho.Locale.addCulture('ro-RO', {
  ...
  messages: {
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Selectare culoare personalizată', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
    ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Faceți clic pentru a deschide selectorul de culori', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Pentru a le încărca, glisați și fixați aici sau <span class="hyperlink">încărcați fișierele</span>', comment: 'Updated recently' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Glisați și fixați aici pentru a încărca fișierele', comment: 'New' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Eroare</em> Nu se poate încărca mai mult decât numărul maxim de fișiere ({maxFiles})', comment: 'New' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Eroare</em> A fost depășită limita maximă permisă pentru fișiere', comment: 'New' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Eroare</em> A fost depășită limita pentru dimensiunea fișierului', comment: 'New' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Eroare</em> Tipul de fișier nu este permis', comment: 'New' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Eroare</em> URL-ul nu a fost găsit', comment: 'New' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Eroare</em> Antetele solicitării trebuie să fie stringuri JSON valide', comment: 'New' },
    UploadLink: { id: 'UploadLink', value: 'încărcare fișiere', comment: 'New' },
    UploadCancel: { id: 'UploadCancel', value: 'Anularea încărcării acestui fișier', comment: 'New' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Revocare totală', comment: 'New' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Respingere eroare', comment: 'New' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} a încărcat {loaded} din {size} ({percent}%)', comment: 'New - contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Eliminarea acestui fișier', comment: 'New' },
    UploadStart: { id: 'UploadStart', value: 'Începerea încărcării acestui fișier', comment: 'New' },
