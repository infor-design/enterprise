...
Soho.Locale.addCulture('ro-RO', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Buton restrângere divizor', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Handle glisare divizor', comment: 'Drags the splitter handle' },
