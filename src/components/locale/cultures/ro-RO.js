...
Soho.Locale.addCulture('ro-RO', {
  ...
  messages: {
    ...
    GroupsPerPage: { id: 'GroupsPerPage', value: '{0} grupuri pe pagină', comment: 'Dropdown allows the user to select how many visible Groups the {} placeholder shows value.' },
    ...
    Large: { id: 'Large', value: 'Mare', comment: 'A larger row sizes with taller rows' },
