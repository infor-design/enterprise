...
Soho.Locale.addCulture('sk-SK', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'Vybrať ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'Vybrať ', comment: 'Audible tooltip for choosing an item in a list.' },
