...
Soho.Locale.addCulture('sk-SK', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: 'Počet záznamov na stranu: {0}', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Tlačidlo zbalenia rozdeľovača', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Rukoväť na posúvanie rozdeľovača', comment: 'Drags the splitter handle' },
