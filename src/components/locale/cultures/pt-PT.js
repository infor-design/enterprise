...
Soho.Locale.addCulture('pt-PT', {
  ...
  messages: {
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} registos por página', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
