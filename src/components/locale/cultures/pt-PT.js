...
Soho.Locale.addCulture('pt-PT', {
  ...
  messages: {
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Selecionar uma cor personalizada', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
    ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Clicar para abrir o seletor de cores', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
    ...
    EarlyOrUntil: { id: 'EarlyOrUntil', value: 'Anterior ou até', comment: 'Earlier than or equals in icons for filtering' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Arrastar e largar ficheiros aqui ou <span class="hyperlink">selecionar ficheiros</span> para carregar', comment: 'Updated recently' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Arrastar e largar aqui para carregar ficheiros', comment: 'New' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Erro</em> Não é possível atualizar mais do que o número máximo de ficheiros ({maxFiles})', comment: 'New' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Erro</em> Limite máximo de ficheiros permitidos excedido', comment: 'New' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Erro</em> Limite do tamanho de ficheiro excedido', comment: 'New' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Erro</em> Tipo de ficheiro não permitido', comment: 'New' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Erro</em> URL não encontrado', comment: 'New' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Erro</em> Solicitar cabeçalhos tem de ser uma cadeia JSON válida', comment: 'New' },
    UploadLink: { id: 'UploadLink', value: 'carregar ficheiros', comment: 'New' },
    UploadCancel: { id: 'UploadCancel', value: 'Cancelar o carregamento deste ficheiro', comment: 'New' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Cancelar tudo', comment: 'New' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Dispensar este erro', comment: 'New' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} carregado {loaded} de {size} ({percent}%)', comment: 'New - contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Remover este ficheiro', comment: 'New' },
    UploadStart: { id: 'UploadStart', value: 'Iniciar o carregamento deste ficheiro', comment: 'New' },
