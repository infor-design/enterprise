...
Soho.Locale.addCulture('pt-PT', {
  ...
  messages: {
    ...
    ExtraSmall: { id: 'ExtraSmall', value: 'Extra pequeno', comment: 'A smaller font size and compressed mode for datagrid rows. NOTE: Please change french to Très petite (Masculine form)' },
