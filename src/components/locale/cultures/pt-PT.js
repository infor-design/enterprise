...
Soho.Locale.addCulture('pt-PT', {
  ...
  messages: {
    ...
    DropdownTriggerButton: { id: 'DropdownTriggerButton', value: 'Clique para abrir a Lista pendente', comment: 'Used in accessible labels to describe a dropdown\'s trigger button to assistive technology' },
