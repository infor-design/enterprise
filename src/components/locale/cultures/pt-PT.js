...
Soho.Locale.addCulture('pt-PT', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Botão para fechar divisor', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Alça de arrastar divisor', comment: 'Drags the splitter handle' },
