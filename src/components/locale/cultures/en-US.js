...
Soho.Locale.addCulture('en-US', {
  ...
  messages: {
    ...
    EndsWith: { id: 'EndsWith', value: 'Ends With', comment: 'for condition filtering (please check this for turkish see https://github.com/infor-design/enterprise/issues/4788)' },
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} Records per page', comment: 'Shows an actual number of pages in the pager. (please check for greek https://github.com/infor-design/enterprise/issues/4791)' },
    ...
    StartsWith: { id: 'StartsWith', value: 'Starts With', comment: 'for condition filtering (please check this for turkish see https://github.com/infor-design/enterprise/issues/4788)' },
