...
Soho.Locale.addCulture('en-US', {
  ...
  messages: {
    ...
    Blockquote: { id: 'Blockquote', value: 'Block quote', comment: 'Term for Block Quotations in editing (please check this for thai see https://github.com/infor-design/enterprise/issues/4738)' },
    ...
    ClearFilter: { id: 'ClearFilter', value: 'Clear Filter', comment: 'Clear the current filter criteria - plese check this for greek https://github.com/infor-design/enterprise/issues/4791' },
    ...
    DatePickerTriggerButton: { id: 'DatePickerTriggerButton', value: 'Date Picker Trigger Button.  Press Enter to select.', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
    ...
    LookupTriggerButton: { id: 'LookupTriggerButton', value: 'Lookup Trigger Button. Press Enter to select.', comment: 'Used in accessible labels to describe a lookup field\'s trigger button to assistive technology' },
