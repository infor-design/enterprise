...
Soho.Locale.addCulture('el-GR', {
  ...
  messages: {
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Κουμπί σύμπτυξης διαχωριστή', comment: 'Action to move the position of splitter either to left or right' },
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Δείκτης μετακίνησης διαχωριστή', comment: 'Drags the splitter handle' },
