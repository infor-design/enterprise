...
Soho.Locale.addCulture('el-GR', {
  ...
  messages: {
    ...
    Large: { id: 'Large', value: 'Μεγάλο', comment: 'A larger row sizes with taller rows' },
    ...
    Small: { id: 'Small', value: 'Μικρό', comment: 'A more small grid setting for rows and sizes' },
