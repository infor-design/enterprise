...
Soho.Locale.addCulture('el-GR', {
  ...
  messages: {
    ...
    CharactersLeft: { id: 'CharactersLeft', value: '{0} χαρακτήρες ακόμη', comment: 'indicator showing how many more characters you can type.' },
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} εγγραφές ανά σελίδα', comment: 'Shows an actual number of pages in the pager. Note: Please change japanese to ページあたりのレコード数' },
