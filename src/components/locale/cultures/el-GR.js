...
Soho.Locale.addCulture('el-GR', {
  ...
  messages: {
    ...
    ChooseA: { id: 'ChooseA', value: 'Επιλογή ', comment: 'Audible tooltip for choosing a thing in a list.' },
    ChooseAn: { id: 'ChooseAn', value: 'Επιλογή ', comment: 'Audible tooltip for choosing an item in a list.' },
