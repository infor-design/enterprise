...
Soho.Locale.addCulture('el-GR', {
  ...
  messages: {
    ...
    Blockquote: { id: 'Blockquote', value: 'Αποκλεισμός προσφοράς', comment: 'Term for Block Quotations in editing (please check this for thai see https://github.com/infor-design/enterprise/issues/4738)' },
    ...
    ClearFilter: { id: 'ClearFilter', value: 'Εκκαθάριση φίλτρου', comment: 'Clear the current filter criteria - plese check this for greek https://github.com/infor-design/enterprise/issues/4791' },
