...
Soho.Locale.addCulture('el-GR', {
  ...
  calendars: [{
    ...
    dateFormat: {
      ...
      dateTimestamp: 'd/M/yyyy h:mm:ss a',
  ...
  messages: {
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Επιλέξτε ένα προσαρμοσμένο χρώμα', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
    ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Κάντε κλικ για να ανοίξετε τον Επιλογέα χρωμάτων', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
    ...
    DropdownTriggerButton: { id: 'DropdownTriggerButton', value: 'Κάντε κλικ για να ανοίξετε το Αναπτυσσόμενο στοιχείο', comment: 'Used in accessible labels to describe a dropdown\'s trigger button to assistive technology' },
    ...
    EarlyOrEquals: { id: 'EarlyOrEquals', value: 'Νωρίτερα από τις ή στις', comment: 'Earlier Than Or Equals in icons for filtering' },
    EarlyThan: { id: 'EarlyThan', value: 'Νωρίτερα από τις', comment: 'Early Than in icons for filtering' },
    ...
    LaterOrEquals: { id: 'LaterOrEquals', value: 'Αργότερα από τις ή στις', comment: 'Later Than Or Equals in icons for filtering' },
    LaterThan: { id: 'LaterThan', value: 'Αργότερα από τις', comment: 'Later Than in icons for filtering' },
    ...
    MenuGroup: { id: 'MenuGroup', value: 'Ομάδα μενού που περιέχει {0} στοιχείο(α)', comment: 'Describes the number of menu items contained inside the group (accessibility when items are focused)' },
    ...
    NextWeek: { id: 'NextWeek', value: 'Επόμενη εβδομάδα', comment: 'the label for the button that moves calendar to next/prev' },
    ...
    PreviousWeek: { id: 'PreviousWeek', value: 'Προηγούμενη εβδομάδα', comment: 'the label for the button that moves calendar to next/prev' },
    ...
    TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Κάντε κλικ για να ανοίξετε τον Επιλογέα ώρας', comment: 'Used in accessible labels to describe a time picker field\'s trigger button to assistive technology' },
