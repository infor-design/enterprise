...
const Locale = {  // eslint-disable-line
  ...
  setCurrentLocale(name, data) {
    ...
    const selectedLang = (this.languages[lang] !== undefined && this.languages[name] !== undefined) && (this.languages[lang].nativeName !== this.languages[name].nativeName) ? name : lang;
