...
const COLORPICKER_DEFAULTS = {
  // Theme key: MUST match with theme file name (ie: [filename: 'theme-soho-light.css' -> 'theme-soho-light'])

  // BORDERS
  // Use (,) commas to separate themes or single entry for border as:
  // colors[{label: 'Slate', number: '01', value: 'F0F0F0',
  // border: 'theme-soho-light, theme-soho-high-contrast'}]
  // and assign which swatch theborder should apply ['all' or 'matched-only']
  // themes: { 'theme-soho-high-contrast': {'border': 'all'} }
  ...
  themes: {
    'soho-light': { border: 'matched-only', checkmark: { one: [1, 2], two: [3, 10] } },
    'soho-dark': { border: 'matched-only', checkmark: { one: [1, 2], two: [3, 10] } },
    'soho-high-contrast': { border: 'all', checkmark: { one: [1, 3], two: [4, 10] } }
  },
  customColors: false,
  colors: [
    { label: 'Slate', number: '10', value: '1a1a1a' },
    { label: 'Slate', number: '09', value: '292929' },
    { label: 'Slate', number: '08', value: '383838', border: 'soho-dark' },
    { label: 'Slate', number: '07', value: '454545', border: 'soho-dark' },
    ...
    { label: 'Slate', number: '01', value: 'F0F0F0', border: 'soho-light, soho-high-contrast' },
