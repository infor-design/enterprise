...
The code above is demoed in the ```html
<a href='https://design.infor.com/code/ids-enterprise/latest/demo/tooltip/example-index?font=source-sans' target='_blank'>common tooltip example</a>```.
...
The code above is demoed in the ```html
<a href='https://design.infor.com/code/ids-enterprise/latest/demo/tooltip/example-html-tooltip?font=source-sans' target='_blank'>HTML tooltip example</a>```.
...
The code above is demoed in the ```html
<a href='https://design.infor.com/code/ids-enterprise/latest/demo/tooltip/example-icon-in-tooltip?font=source-sans' target='_blank'>icons in tooltips example</a>```.
