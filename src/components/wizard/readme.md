...
In addition, a wizard can be used for header navigation. This is a full page pattern so must be shown on its own page. Take a look at the [header wizard examples](./grid) for more details.
