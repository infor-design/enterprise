...
This example shows using a list with a ```html
<a href='https://mustache.github.io/mustache.1.html' target='_blank'>mustache template</a>```. The list itself is the div with the listview class. This example is showing the list in a card but this is optional.
...
- <kbd>Space</kbd> toggles ```html
<a href='http://access.aol.com/dhtml-style-guide-working-group/#checkbox' target='_blank'>checkboxes</a>``` in the case of multi select or a list item in case of normal select
