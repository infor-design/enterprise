...
Personalize.prototype = {
  ...
  getColorStyleSheet(colors) {
    ...
    if (isAlabaster) {
      ...
      colors.darkest = '#19191A';
      colors.contrast = '#19191A';
      ...
      colors.btnFocusBorderColor = '#19191A';
      ...
      colors.tabBottomBorderColor = '#CACACE';
      colors.btnActionsHoverColor = '#19191A';
      ...
      if (isNewDark) {
        ...
        colors.darker = '#4A4A4F';
        colors.btnHoverColor = '#ffffff';
        colors.hyperlinkText = '#ffffff';
        colors.lighter = '#96969C';
        colors.btnDisabledColor = 'rgba(255, 255, 255, 0.4) !important';
        colors.btnPrimaryColorHover = colors.darker;
        colors.btnSecondaryColor = colors.darkest;
        colors.btnSecondaryBorderColor = colors.base;
        colors.btnTertiaryBgHoverColor = '#313135';
        colors.btnTertiaryHoverColor = '#ffffff';
        colors.btnLinkColor = colors.light;
        colors.btnBgHoverColor = '#4A4A4F';
        colors.tabBottomBorderColor = '#7C7C83';
    ...
    colors.baseDisabled = isAlabaster ? '#CACACE' : disabledBGColor;
