...
Button.prototype = {
  ...
  render() {
    ...
    if (this.element.hasClass('btn-tertiary') && this.element.hasClass('btn-gen-ai')) {
      ...
      const svgHoverColor1 = isDarkTheme ? '#10B7A6' : '#1A3362';
      const svgHoverColor2 = isDarkTheme ? '#0B9789' : '#0B9789';
    
      const hasNoIcon = this.element.find('svg.icon').length < 1;
    
      const createTertiaryBtnAi = (position) => `
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" class="icon">
          <svg width="18" height="18" viewBox="0 0 18 18" fill="none" class="original-svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M6 2H4.5V6.25C4.5 6.80228 4.05228 7.25 3.5 7.25H2V8.75H3.5C4.05228 8.75 4.5 9.19772 4.5 9.75V14H6V9.75C6 9.19772 6.44772 8.75 7 8.75H8.5V7.25H7C6.44772 7.25 6 6.80228 6 6.25V2ZM15 3H13.5V4.25C13.5 4.80228 13.0523 5.25 12.5 5.25H11.5V6.75H12.5C13.0523 6.75 13.5 7.19772 13.5 7.75V9H15V7.75C15 7.19772 15.4477 6.75 16 6.75H17V5.25H16C15.4477 5.25 15 4.80228 15 4.25V3ZM10.5 11H12V11.75C12 12.3023 12.4477 12.75 13 12.75H13.5V14.25H13C12.4477 14.25 12 14.6977 12 15.25V16H10.5V15.25C10.5 14.6977 10.0523 14.25 9.5 14.25H9V12.75H9.5C10.0523 12.75 10.5 12.3023 10.5 11.75V11Z" fill="url(#paint0_linear_103_3410)"/>
            <defs>
              <linearGradient id="paint0_linear_103_3410" x1="14.6681" y1="-32.5625" x2="31.7256" y2="-26.8896" gradientUnits="userSpaceOnUse">
                <stop offset="0.117757" stop-color="${position === 'left' ? svgOrigColor1 : svgOrigColor2}" />
                <stop offset="0.927091" stop-color="${position === 'left' ? svgOrigColor2 : svgOrigColor1}" />
              </linearGradient>
            </defs>
          </svg>
    
          <svg width="18" height="18" viewBox="0 0 18 18" fill="none" class="hover-svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M6 2H4.5V6.25C4.5 6.80228 4.05228 7.25 3.5 7.25H2V8.75H3.5C4.05228 8.75 4.5 9.19772 4.5 9.75V14H6V9.75C6 9.19772 6.44772 8.75 7 8.75H8.5V7.25H7C6.44772 7.25 6 6.80228 6 6.25V2ZM15 3H13.5V4.25C13.5 4.80228 13.0523 5.25 12.5 5.25H11.5V6.75H12.5C13.0523 6.75 13.5 7.19772 13.5 7.75V9H15V7.75C15 7.19772 15.4477 6.75 16 6.75H17V5.25H16C15.4477 5.25 15 4.80228 15 4.25V3ZM10.5 11H12V11.75C12 12.3023 12.4477 12.75 13 12.75H13.5V14.25H13C12.4477 14.25 12 14.6977 12 15.25V16H10.5V15.25C10.5 14.6977 10.0523 14.25 9.5 14.25H9V12.75H9.5C10.0523 12.75 10.5 12.3023 10.5 11.75V11Z" fill="url(#paint0_linear_103_3421)"/>
            <defs>
              <linearGradient id="paint0_linear_103_3421" x1="14.6681" y1="-32.5625" x2="31.7256" y2="-26.8896" gradientUnits="userSpaceOnUse">
                <stop offset="0.117757" stop-color="${position === 'left' ? svgHoverColor1 : svgHoverColor2}" />
                <stop offset="0.927091" stop-color="${position === 'left' ? svgHoverColor2 : svgHoverColor1}" />
              </linearGradient>
            </defs>
          </svg>
        </svg>
      ...
      if (hasNoIcon) {
        const position = this.element.hasClass('btn-tertiary-gen-ai-left') ? 'left' : 'right';
        const targetElement = this.element.find('span');
    
        if (position === 'left') {
          targetElement.before(createTertiaryBtnAi(position));
        } else {
          targetElement.after(createTertiaryBtnAi(position));
        }
      }
    }    
