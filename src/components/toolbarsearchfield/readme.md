...
- There is an ```html
<a href='https://design.infor.com/code/ids-enterprise/latest/demo/toolbarsearchfield/example-alternate-style?font=source-sans' target='_blank'>alternate in-page style</a>``` for toolbar searchfields that can be used when content is displayed over a gray background
- ```html
