...
- Default size is 300px wide but there are a number of widths ```html
<a href='https://design.infor.com/code/ids-enterprise/latest/demo/input/example-sizes?font=source-sans' target='_blank'>View Example</a>```
- You can also use the responsive grid ```html
<a href='https://design.infor.com/code/ids-enterprise/latest/demo/form/example-inputs-simple?font=source-sans' target='_blank'>View Example</a>```
