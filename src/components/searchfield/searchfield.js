...
SearchField.prototype = {
  ...
  setOpenWidth() {
    ...
    if (subtractWidth > 0) {
      // Add two more pixels so that the searchfield will not cut off the border when it has text.
      const isAlternate = wrapper.hasClass('alternate') && wrapper.hasClass('has-text') ? 2 : 0;
