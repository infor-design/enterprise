...
### Table of Contents
  ...
  1. [Tools](#tools)
  1. [Sass/Html/Css Style Guide](#indentation)
  1. [Accessibility Checklist](#accessibility)
...
Also in this repo is an .jshintrc file with JSHint config. This is used by both Sublime Linter and Command Line jshint commands as well as grunt-contrib-jshint.

## ESLint

For linting JavaScript ES6 code, ESLint has better support than JSHint. The .eslintrc config is a port of .jshintrc.
...
Just like Sublime, the Atom editor has a linter plugin. For JSHint and ESLint there are [linter-jshint](https://atom.io/packages/linter-jshint) and [linter-eslint](https://atom.io/packages/linter-eslint).

## Sass Linter

This repo contains a .scss-lint.yml you can drop into the root of your project to enforce our sass coding standards. This also works well with Sublime Linter
...
# Sass/Html/Css Style Guide

Keep things clean and compartmentalized. We use SASS and sass linter standards https://github.com/attenzione/SublimeLinter-scss-lint with minor changes from the defaults.

Be DRY, use appropriate variables, nesting and (all the same _mixins.sass) mix-ins and stay organized. Also use sass linter.
...
Remove all trailing whitespaces from files. Sass files which should have one line feed at the end. Use sass linter to enforce this.

## Commenting

Use as needed for better maintainability. And use TODO syntax for future work
...
TODO: Needs examples..
 ...
 - Use HTML5 Syntax
 - Make sure your HTML is valid using http://validator.w3.org/ or https://addons.mozilla.org/en-US/firefox/addon/html-validator/
 - Use new line for every block element and indent child elements
 - Use double quotation marks for attribute values
 - No inline Styles
 - Keep names generic and use structural not presentational names
 - Do not tag qualify
 - Indent all block content
 - Avoid descendant selector
 - Space after a property names  and colon, semicolon after every declaration
 - Use single quotes for property values

## Use hyphens

Use hyphens and no underscores or camel case and no underscores or camel case, but try to avoid the need for it with shorter more succinct names.
...
## Use Short Hand Css Notation

For margin, font, padding ect use short hand notation.
...
<div id="container">
        ...
        <div class="main">
            <div class="wrapper">
                <h1>Page Title</h1>
                <h2>Sub Title</h2>
                <p>Lorem ipsum dolor mammasay mammasa mamma oo sa yippiyo , i'm in the shizzle adipiscing elit .</p>
            </div>
        </div>

        <footer class="footer">
            <p class="copyright">&copy; 2017. Infor. All rights reserved.</p>
        </footer>
    </div>
```
#Accessibility
...
It is an attempt to merge front end JS standards with the Node.js backend coding standards.
...
Add Spaces only after comma in function declarations.

*Right:*

```js
function isSomething(param1, param2) {
  return true;
}
```
...
Declare group multiple variables per var statement. Ignore [Crockford][crockfordconvention] and put vars wherever they make sense.
...
The ternary operator should be used on a single line. If it is too long then use an If.
