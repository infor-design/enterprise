...
describe('Datagrid API', () => {
  ...
  it.skip('should be able to call render', () => {
    datagridObj?.destroy();
  ...
  it.skip('should be able to call addRow and removeRow', () => {
  ...
  it.skip('should be able to show tooltip on either text cut off or not', (done) => {
    datagridObj?.destroy();
  ...
  it.skip('should be able to show tooltip on header text cut off with ellipsis', (done) => {
    datagridObj?.destroy();
    const newColumns = columns.concat();
  ...
  it.skip('should be able to track dirty cells', () => {
    datagridObj?.destroy();
  ...
  it.skip('should be able to validate rows', (done) => {
  ...
  it.skip('should be able to update a cell with the api', () => {
  ...
  it.skip('should be able to toggle an expandable row with the api', (done) => {
    datagridObj?.destroy();
    datagridObj = new Datagrid(datagridEl, {
      dataset: data,
      columns,
  ...
  it.skip('should be able to convert a dataset to a html table', () => {
    const newData = [];
  ...
  it.skip('should be able to do performance check for cleanExtra in excel', () => {
    const newData = [];
