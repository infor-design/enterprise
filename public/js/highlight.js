...
window.Rainbow = (function() {
    ...
    var replacements = {},
        ...
        /**
         * An array of languages and whether they should bypass the default
         * patterns.
         *
         * @type {Object}
         */
         ...
         * processing level
         *
         * replacements are stored at this level so if there is a sub block
         *  of code (for example php inside of html) it runs at a different
         *  level
         *
         * @type {number}
         */
    ...
    function _wrapCodeInSpan(name, code) {
        return '<span class="' + name.replace(/\./g, ' ') + (global_class ? ' ' +
               global_class : '') + '">' + code + '</span>';
    }
