...
const datepickerHTML = `<div class="row">
  <div class="four columns">
    ...
    <div class="field">
      <label for="date-field-disabled" class="label">Date Field (Disabled)</label>
      <input id="date-field-disabled" value="10/31/2014" class="datepicker" disabled="true" name="date-field-disabled" type="text"/>
    </div>

    <div class="field">
      <label for="date-field-readonly" class="label">Date Field (Readonly)</label>
      <input id="date-field-readonly" value="10/31/2014" class="datepicker" readonly="true" name="date-field-readonly" type="text"/>
    </div>

    <div class="field">
      <label for="date-field-legend" class="label">Date Field Legend</label>
      <input id="date-field-legend" value="2021-10-18" class="datepicker" name="date-field-legend" type="text"/>
    </div>
  </div>
</div>`;
...
describe('DatePicker API', () => {
  ...
  it.skip('should open datepicker', (done) => {
  ...
  it.skip('should be able to restrict months', (done) => {
    datepickerAPI.destroy();
    datepickerAPI = new DatePicker(datepickerEl, {
  ...
  it.skip('should render range', (done) => {
    datepickerAPI.destroy();
  ...
  it.skip('should be able to render a different locale', (done) => {
    datepickerAPI.destroy();
