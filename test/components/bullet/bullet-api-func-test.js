...
<div class="row">
  <div class="full column center">
    <div id="bullet-example1" class="chart-container">
    </div>
     <div id="bullet-example2" class="chart-container">
    </div>
  </div>
</div>`;
...
describe('Bullet Chart API', () => {
  ...
  it.skip('Should be able to update', (done) => {
  ...
  it.skip('Should format values with d3 formatter string by Dataset', (done) => {
  ...
  it.skip('Should format values with d3 formatter string by Settings', (done) => {
    const ds = JSON.parse(JSON.stringify(dataset3));
    bulletObj.destroy();
  ...
  it.skip('Should format values with callback function by Dataset', (done) => {
    const ds = JSON.parse(JSON.stringify(dataset3));
    ds[0].format = {
  ...
  it.skip('Should format values with callback function by Settings', (done) => {
    const ds = JSON.parse(JSON.stringify(dataset3));
    bulletObj.destroy();
    bulletObj = new Bullet(bulletEl, {
      dataset: ds,
