...
describe('Badges/Tag accessibility color tests for New Theme', () => {
  const url = 'http://localhost:4000/components/badges/example-index.html';
  beforeAll(async () => {
...
describe('Badges/Tag accessibility color tests for New Theme', () => {
  const url = 'http://localhost:4000/components/badges/example-index.html?theme=new&mode=contrast&colors=003876';
  beforeAll(async () => {
    await page.goto(url, { waitUntil: ['domcontentloaded', 'networkidle0'] });
  });
...
describe('Badges/Tag accessibility color tests for Classic Theme', () => {
  const url = 'http://localhost:4000/components/badges/example-index.html?theme=classic&mode=light&colors=2578a9';
  beforeAll(async () => {
    await page.goto(url, { waitUntil: ['domcontentloaded', 'networkidle0'] });
  });
