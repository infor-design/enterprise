...
const columns = [];
columns.push({ id: 'productId', name: 'Id', field: 'productId', hideable: true, reorderable: true, formatter: Soho.Formatters.Text, width: 100, filterType: 'Text' });
columns.push({ id: 'productName', name: 'Product Name', field: 'productName', hideable: true, reorderable: true, formatter: Soho.Formatters.Hyperlink, width: 300, filterType: 'Text' });
...
columns.push({ id: 'price', align: 'right', name: 'Actual Price', hideable: true, field: 'price', reorderable: true, formatter: Soho.Formatters.Decimal, numberFormat: { minimumFractionDigits: 0, maximumFractionDigits: 0, style: 'currency', currencySign: '$' } });
columns.push({ id: 'percent', align: 'right', name: 'Actual %', hideable: true, field: 'percent', reorderable: true, formatter: Soho.Formatters.Decimal, numberFormat: { minimumFractionDigits: 0, maximumFractionDigits: 0, style: 'percent' } });
columns.push({ id: 'orderDate', name: 'Order Date', field: 'orderDate', hideable: true, reorderable: true, formatter: Soho.Formatters.Date, dateFormat: 'M/d/yyyy' });
columns.push({ id: 'phone', name: 'Phone', field: 'phone', hideable: false, reorderable: true, filterType: 'Text', formatter: Soho.Formatters.Text });
