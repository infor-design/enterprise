...
define({
  ...
  loaderOptions: {
    ...
    packages: [
      ...
      { name: 'chai-arrays', location: './node_modules/chai-arrays' }
    ]
  },
  ...
  suites: [], // remove temporarily 'test/unit/_all'

  // Functional test suite(s) to run in each browser once non-functional tests are completed
  functionalSuites: [],

  // A regular expression matching URLs to files that should not be included in code
  // coverage analysis
