...
| :---    | :---     | :---: |    ---: |
| Approva Applications |An ASP Application interested in accessibility | Shabu Kutty | `3.x` |
...
| CPM Applications (4) |  (Cancelled) | Rick Leedy, Mike Surel | `3.x` |
...
| LMS  | Angular (2.0) interested, using some widgets. Has PM | Tony Shah | `4.x` |
...
| (Infor) PLM Discrete | | Srinivasulu Vadakattu | `^4.x` |
...
| SXE | Angular 1.0 - using XI directly - Huge app it will be another year. | Aaron Pikkarainen | `4.x` |
