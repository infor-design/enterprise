...
- `[Homepage]` Added homepage puppeteer test scripts and snapshots. ([#6144](https://github.com/infor-design/enterprise/issues/6144))
...
- `[Icons]` Update icon design for `icon-mobile`. ([#6091](https://github.com/infor-design/enterprise/issues/6091))
