...
- `[Datepicker]` Fixed a bug in datepicker that the destroy would not re-add masking functionality. [2832](https://github.com/infor-design/enterprise/issues/2832))
