...
- `[Autocomplete]` Fixed an issue where selected event was not firing when its parent partially overflowing. ([#3072](https://github.com/infor-design/enterprise/issues/3072))
