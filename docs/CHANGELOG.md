...
- `[Datagrid]` Fixed an issue where the header button and text would overlap on smaller dimensions on mobile. ([#8093](https://github.com/infor-design/enterprise/issues/8093))
