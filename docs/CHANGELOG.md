...
- `[Searchfiled]` Fixed an issue where the multiselect checkboxes and item text was misaligned for rtl. ([#1811](https://github.com/infor-design/enterprise/issues/1811))
