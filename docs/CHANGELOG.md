...
- `[Calendar]` Added the ability to show tooltip on event and event icon. Also added ability to show event context menu ([#2518](https://github.com/infor-design/enterprise/issues/2518))
