...
- `[Datagrid]` Fixed a bug where the checkbox overlaps with the label when `editorOption` `multiple` is set to true. ([NG#1075](https://github.com/infor-design/enterprise-ng/issues/1075))
