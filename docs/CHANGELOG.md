...
- `[Application Menu]` Fixed issue in application menu where scrollbar is visible even if it's not needed. ([#3134](https://github.com/infor-design/enterprise/issues/3134))
