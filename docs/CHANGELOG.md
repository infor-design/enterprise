...
- `[Modal]` Fixed an issue where unexpected scrollbar appears even if it's not needed in the modal body. ([#2964](https://github.com/infor-design/enterprise/issues/2964))
