...
- `[Toolbar Searchfield]` Fixed a bug where the toolbar search were unable to focused when tabbing through the page. ([#4683](https://github.com/infor-design/enterprise/issues/4683))
