    ...
    copy: {
      main: {
        files: [
          ...
          {expand: true, flatten: true, src: ['js/vendor/d3.js'], dest: 'public/js/', filter: 'isFile'},
          ...
          {expand: true, flatten: true, src: ['js/vendor/d3.min.js'], dest: 'dist/js/', filter: 'isFile'},
          {expand: true, flatten: true, src: ['js/vendor/d3.map'], dest: 'dist/js/', filter: 'isFile'},
          {expand: true, flatten: true, src: ['js/vendor/d3.js'], dest: 'dist/js/', filter: 'isFile'},
