module.exports = function(grunt) {
  grunt.initConfig({
    ...
    concat: {
      ...
      basic: {
        files: {
          'dist/js/<%= pkg.name %>.js': ['js/editor.js', 'js/dropdown.js', 'js/draggable.js', 'js/mask.js', 'js/popupmenu.js', 'js/message.js', 'js/modal.js', 'js/tabs.js', 'js/tooltip.js','js/tree.js', 'js/slider.js'],
