 ...
 * When an app developer calls this directly, it's assumed that the personalization system has already
 * been established (during bootstrapping) and simply needs to be updated with current settings.
 */
