(function (factory) {
  ...
  Locale.addCulture('zh-CN', {
   ...
   messages: {
      ...
      'ChangeSelection': {id: 'ChangeSelection', value: '更改选择请使用箭头键', comment: 'Audible Text for drop down list help'},
    ...
    'InfoOnPage': {id: 'InfoOnPage', value: 'Information message(s) on page', comment: 'Information message(s) on page n'},
      ...
      'ResetDefault': {id: 'ResetDefault', value: '重设为默认值', comment: 'Reset Datagrid Columns, Filter and other Layout'},
      ...
      'TextBtnCloseError': {id: 'TextBtnCloseError', value: '关闭该错误', comment: 'text for error close button for advanced fileupload'},
      'TextBtnRemove': {id: 'TextBtnRemove', value: '关闭该错误', comment: 'text for remove button for advanced fileupload'},
