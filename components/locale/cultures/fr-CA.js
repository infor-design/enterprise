(function (factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define('cultures/fr-CA', ['jquery'], factory);
    factory();
  ...
  Locale.addCulture('fr-CA', {
   ...
   messages: {
      ...
      'AdditionalItems': {id: 'AdditionalItems', value: 'Articles supplémentaires', comment: 'Button tooltip used in a list of movable items'},
      ...
      'AlertOnPage': {id: 'AlertOnPage', value: 'Message(s) d\'alerte sur la page', comment: 'Alert message(s) on page n'},
      ...
      'Clickable': {id: 'Clickable', value: 'Cliquable dans l\'éditeur', comment: 'Clickable in editor'},
      ...
      'ConfirmOnPage': {id: 'ConfirmOnPage', value: 'Confirmer le(s) message(s) sur la page', comment: 'Confirm message(s) on page n'},
      ...
      'ErrorOnPage': {id: 'ErrorOnPage', value: 'Message(s) d\'erreur sur la page', comment: 'Error message(s) on page n'},
      ...
      'Locale': {id: 'Locale', value: 'Paramètres régionaux', comment: 'The users locale string for example en-US, it-It'},
      ...
      'StepsCompleted': {id: 'StepsCompleted', value: '{0} étapes sur {1} terminées', comment: 'steps of a wizard/chart'},
      ...
      'TextDropArea': {id: 'DropArea', value: 'Glissez-déplacez les fichiers à charger', comment: 'text for drop area for advanced fileupload'},
      'TextDropAreaWithBrowse': {id: 'TextDropAreaWithBrowse', value: 'Glissez-déplacez ou <span class="hyperlink »>sélectionnez les fichiers</span> à charger', comment: 'text for drop area with browse for advanced fileupload'},
