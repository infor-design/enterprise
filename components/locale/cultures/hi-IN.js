(function (factory) {
  ...
  Locale.addCulture('hi-IN', {
    ...
    messages: {
      ...
      'FileUpload': {id: 'FileUpload', value: 'फ़ाइल अपलोड करें। एक फ़ाइल के लिए ब्राउज़ करने के लिए एंट्रर दबाएँ', comment: 'Screen Reader instructions'},
      ...
      'Loading': {id: 'Loading', value: 'लदान हो रहा है', comment: 'Text below spinning indicator to indicate loading'},
      ...
      'PasswordValidation': {id: 'PasswordValidation', value: '<strong>पासवर्ड चाहिए</strong><br>कम से कम 10 वर्ण का होना<br>कम से कम एक अपरकेस वर्ण<br>कम से कम एक लोअर केस वर्ण<br>एक विशेष वर्ण शामिल<br>शामिलआपका उपयोगकर्ता नाम शामिल नहीं<br>पहले से उपयोग किया पासवर्ड नहीं हो सकता<br>', comment: 'Password validation requirements'},
      ...
      'UseArrow': {id: 'UseArrow', value: '| चयन करने को तीर कुंजी का उपयोग करें|', comment: 'Instructional comments for screen readers'},
      'UseEnter': {id: 'UseEnter', value: '| लुकअप करने के लिये प्रविष्ट करें या नीचे तीर कुंजी का उपयोग करें।', comment: 'Instructional comments for screen readers'},
