...
Soho.Locale.addCulture('nl-NL', {
  ...
  messages: {
    ...
    AdditionalItems: { id: 'AdditionalItems', value: 'Extra onderdelen', comment: 'Button tooltip used in a list of movable items' },
    ...
    CookiesEnabled: { id: 'CookiesEnabled', value: 'Cookies geactiveerd', comment: 'Returns if browser cookies are enabled or not.' },
    ...
    StepsCompleted: { id: 'StepsCompleted', value: '{0} of {1} stappen voltooid', comment: 'steps of a wizard/chart' },
    ...
    TestLocaleDefaults: { id: 'TestLocaleDefaults', value: 'Defaultwaarden landinstelling testen', comment: 'Do not translate' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Slepen en neerzetten of <span class="hyperlink">Select Files</span> uploaden', comment: 'text for drop area with browse for advanced fileupload' },
    ...
    TextBtnCloseError: { id: 'TextBtnCloseError', value: 'Deze fout afsluiten', comment: 'text for error close button for advanced fileupload' },
    TextBtnRemove: { id: 'TextBtnRemove', value: 'Deze fout afsluiten', comment: 'text for remove button for advanced fileupload' },
