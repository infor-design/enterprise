...
Soho.Locale.addCulture('zh-TW', {
  ...
  messages: {
    ...
    AlertOnPage: { id: 'AlertOnPage', value: '警示消息，頁面', comment: 'Alert message(s) on page n' },
    ...
    ConfirmOnPage: { id: 'ConfirmOnPage', value: '確認消息，頁面', comment: 'Confirm message(s) on page n' },
    CookiesEnabled: { id: 'CookiesEnabled', value: '已啟用 Cookies', comment: 'Returns if browser cookies are enabled or not.' },
    ...
    ErrorOnPage: { id: 'ErrorOnPage', value: '錯誤消息，頁面', comment: 'Error message(s) on page n' },
