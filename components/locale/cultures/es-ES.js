...
Soho.Locale.addCulture('es-ES', {
  ...
  messages: {
    ...
    ConfirmOnPage: { id: 'ConfirmOnPage', value: 'Confirmar mensajes en la página', comment: 'Confirm message(s) on page n' },
    ...
    TextBtnCloseError: { id: 'TextBtnCloseError', value: 'Cerrar este error', comment: 'text for error close button for advanced fileupload' },
    TextBtnRemove: { id: 'TextBtnRemove', value: 'Cerrar este error', comment: 'text for remove button for advanced fileupload' },
