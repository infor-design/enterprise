(function (factory) {
  ...
  Locale.addCulture('es-ES', {
    ...
    messages: {
      ...
      'DaysOverdue': {id: 'DaysOverdue', value: '{0} Días de Atraso', comment: 'For a task /date UI'},
      'DaysRemaining': {id: 'DaysRemaining', value: '{0} Días Restantes', comment: 'For a task /date UI'},
