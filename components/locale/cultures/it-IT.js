...
Soho.Locale.addCulture('it-IT', {
  ...
  messages: {
    ...
    AlertOnPage: { id: 'AlertOnPage', value: 'Messaggi di avviso nella pagina', comment: 'Alert message(s) on page n' },
    ...
    ConfirmOnPage: { id: 'ConfirmOnPage', value: 'Conferma messaggi nella pagina', comment: 'Confirm message(s) on page n' },
    ...
    DaysOverdue: { id: 'DaysOverdue', value: 'Scaduta da {0} giorni', comment: 'For a task /date UI' },
