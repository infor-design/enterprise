...
-   `selectable` **[String](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)**  -  Controls the selection Mode this may be: false, 'single' or 'multiple' or 'mixed' or 'siblings'
...
-   `selectChildren` **[Boolean](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean)**  -  Can prevent selecting of all child nodes on multiselect
