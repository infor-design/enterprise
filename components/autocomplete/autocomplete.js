 ...
 */
let DEFAULT_AUTOCOMPLETE_TEMPLATE = '<li id="{{listItemId}}" data-index="{{index}}" {{#hasValue}}data-value="{{value}}"{{/hasValue}} role="listitem">' + '\n\n' +
 '<a href="#" tabindex="-1">' + '\n\n' +
   '<span>{{{label}}}</span>' + '\n\n' +
 '</a>' + '\n\n' +
'</li>';
 ...
 * @returns {String}
 */
let DEFAULT_AUTOCOMPLETE_SEARCHABLE_TEXT_CALLBACK = function(item) {
 ...
 */
let DEFAULT_AUTOCOMPLETE_RESULT_ITERATOR_CALLBACK = function resultIterator(item, index) {
  ...
  * @returns {String}
  */
let DEFAULT_AUTOCOMPLETE_HIGHLIGHT_CALLBACK = function highlightMatch(item, options) {
  var targetProp = item,
    hasAlias = false;
