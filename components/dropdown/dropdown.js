    ...
    Dropdown.prototype = {
      ...
      */
      ...
      position: function() {
        ...
        positionOpts.y = -(parseInt(parentElement[0].clientHeight) + parseInt(parentElementStyle.borderTopWidth) + parseInt(parentElementStyle.borderBottomWidth) - (isRetina ? 1 : 0));
        positionOpts.x = 0;
