...
-   `resize` **[Object](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)**  -  Fires after the page is resized and layout is set. Can be used for any special adjustments.
